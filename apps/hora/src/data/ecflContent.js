export const COURSE_CONTENT = {
  ...
  // ═══════════════════════════════════════════════════════════════
  // ECFL F1 — FINANCIAL AWARENESS (new course, all 4 ECFL competence areas)
  // ═══════════════════════════════════════════════════════════════

  'lesson-banking-payments': {
    sections: [
      {
        id: 'sec-bank-accounts',
        title: 'How Bank Accounts Work',
        blocks: [
          { type: 'heading', level: 2, content: 'Your Money in the Banking System' },
          ...
          { type: 'keyterm', term: 'Current Account (Checking Account)', definition: 'A transactional bank account used for everyday money management. Current accounts typically allow unlimited deposits and withdrawals, come with a debit card, and provide access to direct debits, standing orders, and bank transfers. They usually pay little or no interest.' },
          { type: 'keyterm', term: 'Savings Account', definition: 'A bank account designed for accumulating funds over time. Savings accounts typically pay interest on the balance, may limit the number of monthly withdrawals, and sometimes require notice before withdrawing (notice accounts).' },
          { type: 'callout', style: 'info', title: 'EU Deposit Guarantee Schemes', content: 'In all EU member states, deposits up to €100,000 per depositor per bank are protected by national Deposit Guarantee Schemes (DGS). If a bank fails, the DGS reimburses you within 7 working days. This protection covers current accounts, savings accounts, and fixed-term deposits — but not investments like shares or bonds.' },
          { type: 'text', content: 'Understanding your account statement is a core financial skill. Every statement shows your <strong>opening balance</strong>, each <strong>credit</strong> (money in) and <strong>debit</strong> (money out), and your <strong>closing balance</strong>. Credits typically appear as positive numbers; debits as negative. If your closing balance is negative, you are <em>overdrawn</em> — you owe money to the bank, and interest charges usually apply.' },
          { type: 'callout', style: 'warning', title: 'Overdraft Costs', content: 'Unauthorised overdrafts (spending beyond your agreed overdraft limit) attract high interest rates and fees in most jurisdictions — sometimes exceeding 40% APR. Always check your balance before large purchases, set up low-balance alerts, and keep a buffer in your current account.' },
          { type: 'activity', style: 'truefalse', title: 'Banking Basics — True or False?', instructions: 'Mark each statement as true or false.', items: [
            { statement: 'All EU bank deposits are protected up to €100,000 per depositor per bank.', answer: true },
            { statement: 'A credit on your bank statement means money has left your account.', answer: false },
            { statement: 'Savings accounts typically pay higher interest than current accounts.', answer: true },
            { statement: 'Being overdrawn means your account balance is below zero.', answer: true }
          ]},
          { type: 'diagram', alt: 'How Fractional Reserve Banking Works', description: 'A flow diagram illustrating fractional reserve banking. Step 1: Customer A deposits €1,000 in Bank. Step 2: Bank holds 10% as reserve (€100) and lends out 90% (€900) to Customer B. Step 3: Customer B spends the €900, which is deposited in another account. Step 4: The cycle repeats — each deposit creates further lending. A sidebar shows: "Reserve requirement: ~10%. Money multiplier effect: €1,000 initial deposit can support ~€10,000 in total lending across the banking system." A note at the bottom reads: "Your deposit is guaranteed up to €100,000 by the EU Deposit Guarantee Scheme even though most of it is on-lent."' }
        ]
      },
      {
        id: 'sec-payment-methods',
        title: 'Payment Methods and Digital Banking',
        blocks: [
          { type: 'heading', level: 2, content: 'How Modern Payments Work' },
          { type: 'text', content: 'The payments landscape has been transformed over the past two decades. The major payment methods you will encounter are:<br><br><strong>Cash</strong> — Physical banknotes and coins. Legal tender in the EU. Accepted everywhere but increasingly less used in Northern European countries.<br><br><strong>Debit card</strong> — Linked directly to your current account. When you pay, the money is deducted from your balance (usually within 24 hours). Uses the Visa or Mastercard network for authorisation.<br><br><strong>Credit card</strong> — Provides a rolling credit facility from your bank or card provider. You spend borrowed money and repay it monthly. If you repay in full each month, you pay no interest. If you carry a balance, interest accrues — typically at 15-25% APR.<br><br><strong>Bank transfer (wire/SEPA credit transfer)</strong> — You instruct your bank to send money directly to another bank account. Within SEPA (Europe), SEPA Instant Credit Transfers can arrive in under 10 seconds.<br><br><strong>Digital wallets</strong> — Apps such as Apple Pay, Google Pay, and PayPal store your card details and enable payments via NFC (tap to pay) or QR code without exposing your card number to the merchant.' },
          { type: 'keyterm', term: 'SEPA (Single Euro Payments Area)', definition: 'A European initiative enabling cross-border euro payments as seamlessly as domestic payments. SEPA includes 36 countries (EU + EEA + UK + Switzerland). SEPA Credit Transfers (SCT) and SEPA Direct Debits (SDD) are the standard payment instruments.' },
          { type: 'callout', style: 'tip', title: 'Online Banking Security', content: 'To protect your bank accounts: (1) Use a unique, strong password and enable two-factor authentication (2FA). (2) Never share your PIN, full password, or one-time codes with anyone — banks will never ask for these. (3) Access internet banking only via official bank apps or websites. (4) Log out after every session. (5) Set up transaction alerts to spot unauthorised activity immediately.' },
          { type: 'text', content: 'Under EU <strong>Payment Services Directive 2 (PSD2)</strong>, you have strong consumer rights when things go wrong. If your card is used fraudulently, your bank must refund you within one business day (subject to an excess of up to €50 for losses before you reported the card missing, unless you acted with gross negligence or fraud). Unauthorised transactions must be contested within 13 months.' },
          { type: 'diagram', alt: 'Payment Methods Comparison', description: 'A comparison table of major payment methods. Columns: Method, Speed, Who Bears Fraud Risk, Best For. Rows: Cash (Instant, You bear it entirely, Small in-person purchases), Debit Card (Seconds–24h, Bank reimburses if disputed, Everyday spending), Credit Card (Seconds–30 days billing, Strong consumer protection, Online purchases, building credit history), SEPA Instant Transfer (<10 seconds, Sender must verify recipient, Paying bills, rent, large transfers), Digital Wallet / NFC (Instant, Bank reimburses, Tap-and-go convenience). A footnote notes: "Credit cards offer the strongest fraud protection because the money is not yet debited from your account."' }
        ]
      }
    ]
  },
  ...
  'lesson-budgeting-saving': {
    sections: [
      {
        id: 'sec-budget-basics',
        title: 'Building Your Budget',
        blocks: [
          { type: 'heading', level: 2, content: 'The Foundation of Financial Control' },
          ...
          { type: 'keyterm', term: 'Needs vs. Wants', definition: 'Needs are expenses essential for basic living: rent/mortgage, food, utilities, transport to work, basic clothing, healthcare. Wants are desirable but non-essential: dining out, streaming subscriptions, holidays, designer clothing. This distinction is the starting point for any budget.' },
          { type: 'text', content: 'The most widely taught budgeting framework is the <strong>50/30/20 rule</strong>, popularised by Senator Elizabeth Warren in her book <em>All Your Worth</em> (2005). It allocates after-tax income as follows:<br><br>• <strong>50% to Needs</strong>: Rent/mortgage, food, transport, utilities, insurance<br>• <strong>30% to Wants</strong>: Entertainment, dining, subscriptions, holidays, clothing above basics<br>• <strong>20% to Savings and Debt Repayment</strong>: Emergency fund, pension, investments, extra debt payments<br><br>This is a guideline, not a rigid rule — the right split depends on your income, location, and financial goals. In high-cost cities, 50% may not be enough for needs. The principle is to assign every euro a purpose before you spend it.' },
          { type: 'callout', style: 'tip', title: 'Pay Yourself First', content: 'The most powerful savings habit is automating a transfer to savings immediately when your salary arrives — before you have the chance to spend it. Set up a standing order from your current account to a separate savings account on your payday. Research in behavioural economics (Thaler & Benartzi, 2004) shows automatic saving dramatically outperforms relying on willpower.' },
          { type: 'diagram', alt: '50/30/20 Budget Rule Visualisation', description: 'A pie chart divided into three segments with example euro amounts based on a €2,000 monthly take-home income. Segment 1 (50% — Needs, €1,000): sub-items: Rent/mortgage €700, Groceries €150, Utilities & transport €150. Segment 2 (30% — Wants, €600): sub-items: Dining & entertainment €200, Subscriptions & shopping €200, Hobbies & holidays €200. Segment 3 (20% — Savings & Debt, €400): sub-items: Emergency fund €200, Pension contributions €100, Debt repayment €100. A note below: "Adjust these percentages for your situation. In high-cost cities, needs may exceed 50% — compensate by reducing wants, not savings."' },
          { type: 'activity', style: 'matching', title: 'Needs or Wants?', instructions: 'Categorise each item as a Need or a Want.', items: [
            { item: 'Rent/mortgage', match: 'Need' },
            { item: 'Netflix subscription', match: 'Want' },
            { item: 'Electricity bill', match: 'Need' },
            { item: 'Restaurant dinner', match: 'Want' },
            { item: 'Basic grocery shopping', match: 'Need' },
            { item: 'New smartphone upgrade', match: 'Want' }
          ]}
        ]
      },
      {
        id: 'sec-saving-goals',
        title: 'Saving Goals and Emergency Funds',
        blocks: [
          { type: 'heading', level: 2, content: 'Making Saving Concrete' },
          { type: 'text', content: 'Abstract savings goals fail. "Save more money" is not a goal — it is a wish. A well-constructed savings goal has three components: <strong>a specific target amount</strong>, <strong>a specific deadline</strong>, and <strong>a defined purpose</strong>. For example: "Save €3,000 for a ski holiday by 15 December. Save €250 per month starting 1 January." This gives you a monthly action and a measurable end point.' },
          { type: 'keyterm', term: 'Emergency Fund', definition: 'A dedicated cash reserve covering 3-6 months of essential living expenses (needs only). Held in an accessible account (not invested), the emergency fund protects you from going into expensive debt when unexpected costs arise: job loss, medical bills, car repair, boiler replacement.' },
          { type: 'text', content: 'The order in which you build financial security matters. Most financial advisers recommend the following priority sequence:<br><br>1. <strong>Emergency fund</strong> (1 month of expenses) — highest priority<br>2. <strong>Repay high-interest debt</strong> (credit cards, overdrafts above ~10%)<br>3. <strong>Emergency fund top-up</strong> (to 3-6 months)<br>4. <strong>Pension contributions</strong> (especially where employer matches)<br>5. <strong>Other savings and investments</strong><br><br>Without an emergency fund, any unexpected expense derails your financial plan and forces you into expensive borrowing.' },
          { type: 'callout', style: 'funfact', title: 'The Latte Factor Debate', content: 'David Bach famously argued in his book <em>The Automatic Millionaire</em> that cutting small daily expenditures (a €5 coffee every day = €1,825/year) and investing the difference could produce significant wealth over decades via compound growth. Critics point out that housing, transport, and healthcare costs dwarf discretionary spending. The real lesson: track <em>all</em> spending to find your actual leakages, not just obvious ones.' },
          { type: 'keyterm', term: 'Compound Interest', definition: 'Interest calculated on the initial principal and also on the accumulated interest from previous periods. Often called the "eighth wonder of the world." Example: €1,000 in a savings account at 4% annual interest. After year 1: €1,040. After year 2: €1,081.60 (interest earns interest). After 20 years: €2,191 — more than double, without adding another cent. The earlier you start saving, the greater the compounding effect.' },
          { type: 'activity', style: 'truefalse', title: 'Saving Goals — True or False?', instructions: 'Mark each statement as true or false.', items: [
            { statement: 'An emergency fund should cover 3–6 months of essential living expenses.', answer: true },
            { statement: 'You should start investing before building an emergency fund.', answer: false },
            { statement: 'Compound interest means you earn interest on your interest as well as your principal.', answer: true },
            { statement: 'Automating savings transfers increases the likelihood of meeting savings goals.', answer: true }
          ]}
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'Risk, Return, and Reality' },
          { type: 'text', content: 'In finance, <strong>risk</strong> describes uncertainty about outcomes — specifically, the possibility that an investment\'s actual return will differ from the expected return. Risk is not inherently bad; without the willingness to accept uncertainty, there would be no possibility of returns above the risk-free rate. The fundamental principle of finance is the <strong>risk-return tradeoff</strong>: assets offering higher expected returns require accepting higher uncertainty (volatility).' },
          { type: 'keyterm', term: 'Risk-Return Tradeoff', definition: 'The principle that higher expected returns are associated with higher risk. A government savings account offers near-zero risk and near-zero return above inflation. Equities offer historically higher long-run returns but with significant short-term volatility. You cannot have high expected returns with guaranteed safety.' },
          { type: 'text', content: 'For ECFL F1 purposes, the key risk categories to recognise are:<br><br>• <strong>Credit risk</strong>: The risk that a borrower defaults. Your bank savings have near-zero credit risk (protected by DGS). Corporate bonds carry higher credit risk than government bonds.<br><br>• <strong>Market risk</strong>: The risk that market prices fall. Shares can fall dramatically in value.<br><br>• <strong>Liquidity risk</strong>: The risk that you cannot sell an investment quickly at a fair price.<br><br>• <strong>Inflation risk</strong>: The risk that returns do not keep up with inflation, eroding purchasing power.<br><br>• <strong>Fraud risk</strong>: The risk of losing money to deceptive schemes.' },
          { type: 'callout', style: 'warning', title: 'Recognising Investment Scams', content: 'The hallmarks of financial fraud: (1) Guaranteed high returns with no risk — impossible in legitimate finance. (2) Pressure to invest immediately. (3) Unregistered firms or individuals. (4) Unusual payment methods (cryptocurrency, gift cards, wire to foreign accounts). (5) Returns paid from new investors\' money rather than genuine profits (Ponzi scheme). Always check if a firm is authorised by your national financial regulator before investing.' },
          { type: 'diagram', alt: 'Risk-Return Spectrum', description: 'A horizontal spectrum arrow from left (Low Risk / Low Return) to right (High Risk / High Return). Plotted along the spectrum from left to right: EU Deposit Guarantee protected savings (near 0% risk, ~2-4% return), Government bonds — EU sovereign (low risk, ~3-5% return), Corporate bonds — investment grade (moderate-low risk, ~4-6% return), Property / real estate (moderate risk, ~6-10% total return), Global equity index funds (moderate-high risk, ~7-10% long-run return), Individual company shares (high risk, variable), Cryptocurrencies like Bitcoin (very high risk, historically high but volatile return), Speculative altcoins (extreme risk, most have declined to zero). A red dashed box at the far right labelled "Scam zone: promises of guaranteed 20%+ with no risk — does not exist in legitimate finance."' }
        ]
      },
      {
        id: 'sec-insurance-basics',
        title: 'How Insurance Works',
        blocks: [
          { type: 'heading', level: 2, content: 'Transferring Risk' },
          { type: 'text', content: 'Insurance is a risk transfer mechanism: you pay a regular <strong>premium</strong> to an insurance company in exchange for financial protection against a defined set of losses. The insurer pools premiums from many customers; the few who suffer losses receive payouts from this pool. Because not everyone suffers a loss simultaneously, the insurer can charge premiums lower than the full cost of replacing each customer\'s loss.' },
          { type: 'keyterm', term: 'Premium', definition: 'The regular payment (monthly or annual) made to an insurance company in exchange for coverage. The premium reflects the insurer\'s assessment of the probability and potential cost of the insured event occurring, plus the insurer\'s profit margin and operating costs.' },
          { type: 'keyterm', term: 'Excess (Deductible)', definition: 'The portion of a claim you must pay yourself before the insurer covers the rest. A higher excess reduces your premium (because you bear more risk) but means you pay more out of pocket when you claim.' },
          { type: 'text', content: 'Common insurance types you will encounter:<br><br>• <strong>Contents insurance</strong>: Covers personal belongings in your home against theft, fire, water damage<br>• <strong>Buildings insurance</strong>: Covers the structure of the property<br>• <strong>Health insurance</strong>: Covers medical costs (supplements state healthcare in many EU countries)<br>• <strong>Life insurance</strong>: Pays a lump sum to beneficiaries if the insured person dies<br>• <strong>Income protection</strong>: Replaces a portion of income if you are unable to work due to illness or disability<br>• <strong>Car insurance</strong>: Third-party liability is mandatory in the EU; comprehensive cover also protects your own vehicle' },
          { type: 'callout', style: 'tip', title: 'Insurance Is Not Investment', content: 'Insurance is a cost — you are paying to transfer risk. If you never make a claim, you have not "lost" the premiums: you have purchased peace of mind and financial protection for a period. Do not confuse insurance-linked savings products (common in some European markets) with pure insurance; always check the charges, guaranteed returns, and surrender conditions of any combined product.' },
          { type: 'activity', style: 'truefalse', title: 'Insurance Basics — True or False?', instructions: 'Mark each statement as true or false.', items: [
            { statement: 'A higher excess on your insurance policy reduces your premium.', answer: true },
            { statement: 'Life insurance pays out if you become unable to work due to illness.', answer: false },
            { statement: 'Contents insurance covers the physical structure of a building.', answer: false },
            { statement: 'Third-party car insurance is mandatory in all EU member states.', answer: true },
            { statement: 'Paying premiums that never result in a claim means you wasted your money.', answer: false }
          ]}
        ]
      }
    ]
  ...
  'lesson-consensus': {
    sections: [
      ...
      },
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'Mining: Computation as Security' },
          { type: 'text', content: 'Proof-of-work was the first blockchain consensus mechanism, introduced by Satoshi Nakamoto in the Bitcoin protocol. Under PoW, miners compete to find a number (a <strong>nonce</strong>) that, when combined with the block\'s data and hashed, produces a result below a target threshold. This is essentially a brute-force guessing game — the only way to find a valid nonce is to try billions of possibilities per second.' },
          { type: 'keyterm', term: 'Hash Rate', definition: 'The total computational power devoted to mining a proof-of-work blockchain, measured in hashes per second. Bitcoin\'s hash rate exceeded 500 exahashes per second (EH/s) in early 2024 — meaning the network collectively performs 500 quintillion SHA-256 hash computations every second. Higher hash rates make the network more secure against 51% attacks.' },
          { type: 'text', content: 'The difficulty of the puzzle adjusts automatically to maintain a target block time. Bitcoin adjusts every 2,016 blocks (~2 weeks) to target 10-minute blocks. If miners join the network and blocks are found too quickly, difficulty increases; if miners leave, difficulty decreases. This self-regulating mechanism ensures that block production remains predictable regardless of changes in total hash power.' },
          { type: 'callout', style: 'warning', title: '51% Attacks', content: 'If a single entity controls more than 50% of a PoW network\'s hash rate, they could theoretically reorganise the blockchain and double-spend. While this has never happened on Bitcoin (the cost would be billions of dollars), smaller PoW chains have been attacked: Ethereum Classic suffered three 51% attacks in August 2020, and Bitcoin Gold was attacked in 2018. This vulnerability is a key argument for why only networks with massive hash power can safely rely on PoW.' },
          { type: 'text', content: 'PoW mining has evolved through distinct hardware generations. Early Bitcoin mining used CPUs (2009), then GPUs (2010), then FPGAs (2011), and finally custom ASICs (Application-Specific Integrated Circuits) from 2013 onward. Modern ASICs like the Bitmain Antminer S21 achieve approximately 200 TH/s while consuming around 3,550 watts. This specialisation has made mining increasingly capital-intensive and industrial in scale.' },
          { type: 'text', content: 'Major PoW blockchains today include Bitcoin, Litecoin (using the Scrypt algorithm), Dogecoin (also Scrypt, merge-mined with Litecoin), and Kaspa (using the GHOSTDAG protocol). Ethereum was the second-largest PoW network before transitioning to PoS in September 2022.' }
        ]
      },
      {
        id: 'sec-pos',
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'activity', style: 'ordering', title: 'Wallet Security Ranking', instructions: 'Arrange these wallet types from LEAST secure to MOST secure for long-term storage.', items: [
            'Exchange account (e.g., holding BTC on Coinbase)',
            'Browser extension hot wallet (e.g., MetaMask)',
            'Mobile wallet with biometric lock (e.g., Trust Wallet)',
            'Hardware wallet (e.g., Ledger Nano X)',
            'Multi-signature cold storage with geographically distributed keys'
          ]}
        ]
      }
    ]
  ...
  'lesson-risk': {
    sections: [
      {
        id: 'sec-risk-why',
        title: 'Why Risk Management Is Rule Number One',
        blocks: [
          { type: 'heading', level: 2, content: 'Survival Before Profits' },
          { type: 'text', content: 'Every successful trader — from Jesse Livermore in the 1920s to Ray Dalio today — will tell you the same thing: <strong>risk management is the single most important skill in trading</strong>. It is not about picking winners. It is about ensuring that when you are wrong (and you will be wrong, frequently), the losses do not destroy your ability to continue trading.' },
          { type: 'quote', text: 'Rule No. 1: Never lose money. Rule No. 2: Never forget Rule No. 1.', attribution: 'Warren Buffett' },
          { type: 'text', content: 'The mathematics of recovery make this concrete. A 10% loss requires an 11.1% gain to break even. A 25% loss requires 33.3%. A 50% loss requires 100%. And a 90% loss — common in crypto bear markets for altcoins — requires a 900% gain just to get back to where you started. This asymmetry means that <em>avoiding large losses</em> is far more important than capturing large gains.' },
          { type: 'callout', style: 'warning', title: 'The Ruin Equation', content: 'If you risk 50% of your account on every trade and have a 50% win rate with 1:1 reward-to-risk, probability theory guarantees you will eventually go bankrupt. Even with a 60% win rate, large position sizes create unacceptable ruin risk. The foundational principle is: size your positions so that even a string of consecutive losses cannot materially impair your capital.' },
          { type: 'keyterm', term: 'Risk of Ruin', definition: 'The probability that a trader will lose enough capital to be unable to continue trading. Risk of ruin is a function of win rate, reward-to-risk ratio, and the percentage of capital risked per trade. Professional traders typically manage position sizes to keep their risk of ruin below 1%.' },
          { type: 'diagram', alt: 'Loss Recovery Table', description: 'A table showing the non-linear relationship between losses and the gains required to recover. Columns: Loss Percentage and Required Gain to Break Even. Rows: 10% loss needs 11.1%, 20% needs 25%, 30% needs 42.9%, 40% needs 66.7%, 50% needs 100%, 60% needs 150%, 70% needs 233%, 80% needs 400%, 90% needs 900%. The table highlights that losses compound asymmetrically.' }
        ]
      },
      {
        id: 'sec-position-sizing',
        title: 'Position Sizing: The 1-2% Rule',
        blocks: [
          { type: 'heading', level: 2, content: 'How Much to Risk Per Trade' },
          { type: 'text', content: 'The <strong>1-2% rule</strong> states that you should never risk more than 1-2% of your total trading capital on any single trade. "Risk" here means the maximum amount you would lose if your stop-loss is hit — not the total position size. This rule ensures that even 10 consecutive losing trades (which will happen) only draw down your account by 10-20%.' },
          { type: 'text', content: 'Here is a concrete example. Suppose you have a $10,000 trading account and you want to buy Bitcoin at $60,000 with a stop-loss at $57,000 (a $3,000 per-BTC risk). Using the 1% rule, your maximum risk per trade is $100 (1% of $10,000). Since each BTC risks $3,000, your position size is $100 / $3,000 = 0.0333 BTC, or about $2,000 worth. You are buying $2,000 of Bitcoin but only risking $100.' },
          { type: 'keyterm', term: 'Position Sizing', definition: 'The process of determining how large a trading position to take based on your account size, risk tolerance, and the distance to your stop-loss. Position size = (Account Balance x Risk Percentage) / (Entry Price - Stop-Loss Price). This formula ensures consistent risk exposure regardless of the trade setup.' },
          { type: 'callout', style: 'tip', title: 'Position Sizing Formula', content: 'Position Size (units) = (Account Size x Risk %) / Dollar Risk per Unit. Example: $50,000 account, 2% risk, buying ETH at $3,000 with stop at $2,850. Dollar risk per unit = $150. Position size = ($50,000 x 0.02) / $150 = 6.67 ETH (~$20,000). You are buying $20,000 of ETH but only risking $1,000 (2% of your account).' },
          { type: 'text', content: 'Many professional traders further limit their <strong>total portfolio risk</strong> — the sum of all open position risks — to 6-10% of account equity. This means if you are risking 2% per trade, you might hold a maximum of 3-5 open positions simultaneously. This prevents correlation risk: if you hold 10 long positions in crypto and the entire market drops 20%, all 10 stop-losses might trigger simultaneously.' },
          { type: 'activity', style: 'truefalse', title: 'Position Sizing — True or False?', instructions: 'Test your understanding of position sizing principles.', items: [
            { statement: 'The 1-2% rule refers to the percentage of your account that you allocate to a trade.', answer: false },
            { statement: 'A trader with a $20,000 account using the 1% rule should risk no more than $200 per trade.', answer: true },
            { statement: 'Position size depends only on account size, not on stop-loss distance.', answer: false },
            { statement: 'Total portfolio risk should generally be capped at 6-10% of account equity.', answer: true },
            { statement: 'Ten consecutive losses using the 2% rule would result in approximately an 18% account drawdown.', answer: true }
          ]}
        ]
      },
      {
        id: 'sec-rr-kelly',
        title: 'Reward-to-Risk and the Kelly Criterion',
        blocks: [
          { type: 'heading', level: 2, content: 'Mathematical Edge and Optimal Sizing' },
          { type: 'text', content: 'The <strong>reward-to-risk ratio</strong> (R:R or R-multiple) compares the potential profit of a trade to the potential loss. If your target profit is $300 and your stop-loss risk is $100, your R:R is 3:1. This ratio, combined with your win rate, determines whether a trading strategy has a positive <em>expected value</em>.' },
          { type: 'keyterm', term: 'Expected Value (EV)', definition: 'The average outcome of a trade if repeated many times. EV = (Win Rate x Average Win) - (Loss Rate x Average Loss). A strategy is profitable if EV > 0. Example: 40% win rate with 3:1 R:R gives EV = (0.40 x $3) - (0.60 x $1) = $1.20 - $0.60 = +$0.60 per dollar risked. Even winning less than half the time can be highly profitable with good R:R.' },
          { type: 'text', content: 'Professional traders typically seek setups with a minimum R:R of 2:1 or 3:1. This creates a buffer: with a 2:1 R:R, you only need to win 34% of trades to break even (ignoring fees). With 3:1, the breakeven win rate drops to 25%. Many successful trend-following systems win only 30-40% of trades but are highly profitable because winners are 3-5x larger than losers.' },
          { type: 'text', content: 'The <strong>Kelly Criterion</strong>, developed by John Kelly at Bell Labs in 1956, provides a formula for the mathematically optimal bet size given a known edge. Kelly % = W - (1-W)/R, where W is the win rate and R is the reward-to-risk ratio. For example, with a 55% win rate and 2:1 R:R: Kelly % = 0.55 - (0.45/2) = 0.55 - 0.225 = 32.5%. In practice, traders use "fractional Kelly" (typically half or quarter Kelly) because the formula assumes perfect knowledge of your edge, which real-world trading never provides.' },
          { type: 'callout', style: 'warning', title: 'Kelly Criterion Caution', content: 'Full Kelly sizing is dangerously aggressive for real-world trading. Overestimating your edge (win rate or R:R) leads to catastrophic over-sizing. Most quantitative traders and hedge funds use quarter-Kelly to half-Kelly. Ed Thorp, the legendary mathematician who applied Kelly to blackjack and later to financial markets, consistently advocated for fractional Kelly to account for parameter uncertainty.' },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'activity', style: 'ordering', title: 'Risk Management Process', instructions: 'Arrange these steps in the correct order for planning a risk-managed trade.', items: [
            'Identify a trade setup with clear entry and invalidation levels',
            'Calculate the dollar distance between entry and stop-loss',
            'Determine the maximum dollar amount to risk (1-2% of account)',
            'Calculate position size using the formula: risk amount / dollar risk per unit',
            'Place the trade with a predefined stop-loss and take-profit',
            'Monitor the trade and adjust the stop-loss only in a favourable direction'
          ]}
        ]
      },
    ]
  ...
  // ═══════════════════════════════════════════════════════════════
  // ECFL PROFESSIONAL COURSES — F3 CFA-LEVEL CONTENT
  // These lessons are ONLY shown in the ECFL Certification section.
  // They are NOT linked from the game textbook sidebar.
  // ═══════════════════════════════════════════════════════════════

  'lesson-ecfl-f3-mpt': {
    sections: [
      {
        id: 'sec-mpt-efficient-frontier',
        title: 'Modern Portfolio Theory and the Efficient Frontier',
        blocks: [
          { type: 'heading', level: 2, content: 'Harry Markowitz and the Science of Diversification' },
          { type: 'text', content: 'Harry Markowitz published "Portfolio Selection" in the <em>Journal of Finance</em> in 1952 — a paper that revolutionised investment theory and earned him the 1990 Nobel Prize. The central insight was deceptively simple: <strong>investors should not evaluate assets in isolation, but rather in terms of their contribution to portfolio risk and return</strong>. The mathematics of combining risky assets can reduce overall portfolio risk below the risk of any individual asset — a result that seemed counterintuitive until Markowitz formalised it.' },
          { type: 'keyterm', term: 'Expected Portfolio Return', definition: 'E(R_p) = Σ w_i × E(R_i), where w_i is the weight of asset i and E(R_i) is its expected return. For a two-asset portfolio: E(R_p) = w_A × E(R_A) + w_B × E(R_B). Example: 60% in Asset A (expected return 12%) and 40% in Asset B (expected return 8%) gives E(R_p) = 0.60 × 0.12 + 0.40 × 0.08 = 0.072 + 0.032 = 10.4%.' },
          { type: 'keyterm', term: 'Portfolio Variance', definition: 'σ²_p = w²_A × σ²_A + w²_B × σ²_B + 2 × w_A × w_B × Cov(A,B), where Cov(A,B) = ρ_{AB} × σ_A × σ_B. The key term is the covariance: when assets are less than perfectly correlated (ρ < 1), portfolio variance is less than the weighted average variance — this IS the diversification benefit. The lower the correlation between assets, the greater the risk reduction from combining them.' },
          { type: 'text', content: 'Consider a worked example with two assets: Bitcoin (expected return 60%, standard deviation 80%) and Gold (expected return 8%, standard deviation 15%). Correlation ρ = 0.10. Portfolio weights: 30% BTC, 70% Gold. E(R_p) = 0.30 × 0.60 + 0.70 × 0.08 = 0.18 + 0.056 = <strong>23.6%</strong>. Portfolio variance = (0.30)² × (0.80)² + (0.70)² × (0.15)² + 2 × 0.30 × 0.70 × 0.10 × 0.80 × 0.15 = 0.0576 + 0.011025 + 0.00504 = <strong>0.0737</strong>. Portfolio σ = √0.0737 = <strong>27.1%</strong>. The weighted average standard deviation would have been 0.30 × 0.80 + 0.70 × 0.15 = 34.5% — significantly higher. The diversification reduced risk from 34.5% to 27.1% while maintaining a 23.6% expected return.' },
          { type: 'callout', style: 'info', title: 'The Role of Correlation', content: 'When ρ = +1 (perfect positive correlation), there is no diversification benefit — portfolio volatility is simply the weighted average. When ρ = 0 (no correlation), partial diversification is achieved. When ρ = -1 (perfect negative correlation), assets move in exact opposition — a portfolio can theoretically be constructed with zero variance. In practice, no large-scale assets have ρ = -1, but combining assets with low or negative correlations (equities + government bonds, BTC + gold) provides meaningful risk reduction.' },
          { type: 'text', content: 'The <strong>Efficient Frontier</strong> is the set of portfolios that offers the maximum expected return for each level of risk (or equivalently, the minimum risk for each level of expected return). Points on the efficient frontier are "Pareto optimal" — you cannot improve expected return without increasing risk, or reduce risk without sacrificing expected return. Any portfolio below the efficient frontier is suboptimal: there exists a better portfolio at the same risk level.' },
          { type: 'diagram', alt: 'The Efficient Frontier', description: 'A scatter plot with portfolio standard deviation (σ) on the x-axis and expected return on the y-axis. Individual asset bubbles are scattered across the plot. A curved line represents the efficient frontier — the upper-left boundary of all possible portfolios. The minimum variance portfolio (MVP) is highlighted at the leftmost point on the frontier. The region below and to the right of the frontier contains all inefficient portfolios. Arrows indicate that moving upward (more return) requires moving right (more risk) along the frontier.' },
          { type: 'text', content: 'In practice, constructing the efficient frontier requires estimating three inputs for each asset: expected return, variance, and covariance with every other asset. For n assets, this requires n expected returns, n variances, and n(n-1)/2 covariances. A 50-asset portfolio requires estimating 50 + 50 + 1,225 = 1,325 parameters. Errors in these estimates — particularly expected returns, which are notoriously difficult to forecast — cause the efficient frontier to be unstable and sensitive to small changes in inputs. This is a well-known weakness of mean-variance optimisation in practice.' },
          { type: 'activity', style: 'truefalse', title: 'Modern Portfolio Theory — True or False?', instructions: 'Apply your understanding of MPT.', items: [
            { statement: 'Adding an asset with a high expected return always improves portfolio efficiency.', answer: false },
            { statement: 'Portfolio variance depends on the covariances between all pairs of assets, not just individual variances.', answer: true },
            { statement: 'Two assets with perfect positive correlation (ρ = +1) can still reduce portfolio variance when combined.', answer: false },
            { statement: 'All portfolios on the efficient frontier have the same Sharpe ratio.', answer: false },
            { statement: 'The minimum variance portfolio is the portfolio with the lowest possible standard deviation regardless of expected return.', answer: true }
          ]}
        ]
      },
      {
  ...
  'lesson-candlesticks': {
    sections: [
      ...
      },
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'Engulfing, Morning Star, and Evening Star' },
          { type: 'text', content: 'Multi-candle patterns are generally more reliable than single-candle patterns because they represent a <em>shift in control</em> over multiple periods. The most widely followed are two-candle and three-candle reversal patterns.' },
          { type: 'keyterm', term: 'Engulfing Pattern', definition: 'A two-candle reversal pattern. A Bullish Engulfing occurs when a small bearish candle is followed by a larger bullish candle whose body completely engulfs (covers) the previous candle\'s body. This shows that buyers overwhelmed the sellers. A Bearish Engulfing is the reverse: a small bullish candle followed by a larger bearish candle. Both patterns are most significant at trend extremes and support/resistance levels.' },
          { type: 'text', content: 'The <strong>Morning Star</strong> is a three-candle bullish reversal pattern: (1) a large bearish candle continuing the downtrend, (2) a small-bodied candle (often a doji) that gaps lower, signalling indecision, and (3) a large bullish candle that closes well into the first candle\'s body. The pattern represents the transition from selling pressure to indecision to buying pressure. The <strong>Evening Star</strong> is the bearish mirror image.' },
          { type: 'text', content: 'The <strong>Three White Soldiers</strong> pattern consists of three consecutive bullish candles, each opening within the prior candle\'s body and closing at or near its high. This indicates sustained buying pressure and often marks the beginning of an uptrend. The bearish counterpart, <strong>Three Black Crows</strong>, consists of three consecutive bearish candles and signals the start of a downtrend.' },
          { type: 'callout', style: 'info', title: 'Statistical Edge of Patterns', content: 'Research by Thomas Bulkowski (Encyclopedia of Candlestick Charts) found that while no candlestick pattern works reliably in isolation, certain patterns show meaningful statistical edges when combined with context. Bullish engulfing patterns in a downtrend correctly predicted a reversal approximately 63% of the time. The key takeaway: candlestick patterns are a tool for identifying potential turning points, not a standalone trading system.' },
          { type: 'activity', style: 'truefalse', title: 'Candlestick Patterns — True or False?', instructions: 'Test your understanding of candlestick chart patterns.', items: [
            { statement: 'A doji candle has a large body and no wicks.', answer: false },
            { statement: 'A hammer at the bottom of a downtrend is considered a bullish reversal signal.', answer: true },
            { statement: 'A bullish engulfing pattern requires the second candle\'s body to completely cover the first candle\'s body.', answer: true },
            { statement: 'Candlestick patterns are more reliable when they occur in isolation, away from support and resistance.', answer: false },
            { statement: 'The Morning Star is a three-candle bullish reversal pattern.', answer: true }
          ]}
        ]
      }
    ]
  ...
  'lesson-order-types': {
    sections: [
      {
        id: 'sec-market-orders',
        title: 'Market Orders and Execution',
        blocks: [
          { type: 'heading', level: 2, content: 'Instant Execution at the Best Available Price' },
          ...
          { type: 'keyterm', term: 'Slippage', definition: 'The difference between the expected price of a trade and the price at which it actually executes. Positive slippage means you get a better price than expected; negative slippage means you get a worse price. Slippage increases with order size and decreases with market liquidity. A $100 market buy of BTC might experience 0.01% slippage, while a $1 million market buy of a small-cap altcoin could experience 2-5% slippage.' },
          { type: 'text', content: 'Every exchange maintains an <strong>order book</strong> — a list of all outstanding buy orders (bids) and sell orders (asks) organised by price. When you submit a market buy order, it is matched against the lowest-priced sell orders in the book. If your order is larger than the quantity available at the best price, it "walks up the book," filling at progressively higher prices. This is why large market orders in illiquid markets can move the price significantly.' },
          { type: 'diagram', alt: 'Order Book Visualisation', description: 'A depth chart showing the order book for BTC/USDT. The left side (green) shows buy orders (bids) stacking up below the current price. The right side (red) shows sell orders (asks) stacking up above the current price. The gap between the highest bid and lowest ask is labelled "Spread." Annotations show that a market buy order fills from the lowest ask upward, while a market sell fills from the highest bid downward.' },
          { type: 'callout', style: 'warning', title: 'Market Orders During Volatility', content: 'During extreme market events (flash crashes, liquidation cascades), the order book can thin dramatically. On 19 May 2021, Bitcoin dropped from $43,000 to $30,000 in hours. Market sell orders during such events can execute at prices far below what the trader intended. This is why many experienced traders use limit orders instead, especially during volatile conditions or for larger position sizes.' },
          { type: 'text', content: 'The <strong>bid-ask spread</strong> is the difference between the highest bid and the lowest ask. It represents the cost of immediacy — the premium you pay for instant execution via a market order. BTC/USDT on major exchanges typically has a spread of $0.01-$1.00, while exotic altcoin pairs might have spreads of 0.5-2% of the price. The spread is a hidden transaction cost that should be factored into trade planning.' }
        ]
      },
      {
        id: 'sec-limit-orders',
        title: 'Limit Orders: Price Control',
        blocks: [
          { type: 'heading', level: 2, content: 'Setting Your Price' },
          ...
          { type: 'keyterm', term: 'Limit Order', definition: 'An order to buy or sell at a specified price or better. A buy limit order is placed below the current market price and executes only if the price drops to the limit level. A sell limit order is placed above the current market price and executes only if the price rises to the limit level. Limit orders that are not immediately filled become "resting orders" in the order book, providing liquidity to the market.' },
          { type: 'text', content: 'Limit orders carry several advantages: <strong>No slippage</strong> — you get exactly the price you specified (or better). <strong>Lower fees</strong> — many exchanges charge lower fees for limit orders (maker fees) than market orders (taker fees), because limit orders add liquidity to the order book. On Binance, for instance, maker fees can be 50-75% lower than taker fees at certain VIP levels.' },
          { type: 'text', content: 'The primary risk of limit orders is <strong>non-execution</strong>. If you set a buy limit for BTC at $55,000 and the price drops to $55,050 before rallying to $70,000, your order never fills and you miss the entire move. This is why some traders use a combination: enter with a limit order at their target level but place a "contingency" market order if the price starts to run away.' },
          { type: 'callout', style: 'tip', title: 'Maker vs Taker Explained', content: 'When your limit order is placed in the order book and waits to be filled, you are a "maker" — you are making (providing) liquidity. When your order immediately matches against an existing order, you are a "taker" — you are taking (removing) liquidity. Exchanges incentivise makers with lower fees because they improve the market. Market orders are always taker orders. Limit orders can be either, depending on whether they fill immediately.' },
          { type: 'activity', style: 'truefalse', title: 'Order Types — True or False?', instructions: 'Test your knowledge of market and limit orders.', items: [
            { statement: 'A market order guarantees execution at your specified price.', answer: false },
            { statement: 'Slippage tends to increase as order size increases and liquidity decreases.', answer: true },
            { statement: 'A buy limit order is placed above the current market price.', answer: false },
            { statement: 'Maker fees are typically lower than taker fees on exchanges.', answer: true },
            { statement: 'Limit orders always execute immediately upon being placed.', answer: false }
          ]}
        ]
      },
      {
        id: 'sec-stop-orders',
        title: 'Stop Orders and Advanced Types',
        blocks: [
          { type: 'heading', level: 2, content: 'Stop-Market, Stop-Limit, and Conditional Orders' },
          ...
          { type: 'keyterm', term: 'Stop-Market Order', definition: 'An order that triggers a market order when the price reaches a specified stop level. Example: You are long BTC at $65,000 and place a stop-market sell at $62,000. If BTC drops to $62,000, the stop triggers and immediately sells at the best available price. Advantages: guaranteed execution. Disadvantage: slippage during fast moves — you might sell at $61,500 or lower during a flash crash.' },
          { type: 'keyterm', term: 'Stop-Limit Order', definition: 'An order that triggers a limit order when the price reaches a specified stop level. It has two prices: the stop (trigger) price and the limit price. Example: Stop at $62,000, limit at $61,800. When price hits $62,000, a limit sell at $61,800 is placed. Advantage: you control the worst execution price. Disadvantage: if the price gaps below $61,800, the order may not fill at all, leaving you exposed.' },
          { type: 'text', content: 'Modern exchanges offer additional advanced order types. <strong>OCO (One-Cancels-the-Other)</strong> pairs a take-profit limit order with a stop-loss order — when one fills, the other is automatically cancelled. <strong>Trailing stop</strong> orders follow the price at a fixed distance or percentage. <strong>Iceberg orders</strong> split large orders into smaller visible portions to avoid moving the market.' },
          { type: 'callout', style: 'info', title: 'Exchange-Specific Differences', content: 'Order types vary by exchange. Coinbase Pro offers basic market, limit, and stop-limit orders. Binance offers all of the above plus OCO, trailing stop, and TWAP (Time-Weighted Average Price). Deribit (derivatives-focused) adds post-only orders and reduce-only orders. Decentralised exchanges like Uniswap only support market swaps by default, though advanced DEXs like dYdX offer limit and stop orders on-chain.' },
          { type: 'diagram', alt: 'Stop Order Flow Diagram', description: 'A flowchart comparing stop-market and stop-limit orders. Start: "Price reaches stop trigger level." Branch 1 (Stop-Market): Arrow to "Market order placed" then to "Fills at best available price — execution guaranteed, slippage possible." Branch 2 (Stop-Limit): Arrow to "Limit order placed at specified limit price" then to a decision: "Is the limit price reachable?" If Yes: "Fills at limit price or better." If No: "Order remains unfilled — no protection."' },
  ...
  // ═══════════════════════════════════════════════════════════════
  // COURSE 3 — RISK & PORTFOLIO MANAGEMENT
  // ═══════════════════════════════════════════════════════════════

  'lesson-diversification': {
    sections: [
      {
        id: 'sec-diversification-why',
        title: 'The Case for Diversification',
        blocks: [
          { type: 'heading', level: 2, content: 'The Only Free Lunch in Finance' },
  ...
  'lesson-volatility': {
    sections: [
      {
        id: 'sec-volatility-basics',
        title: 'Measuring Volatility',
        blocks: [
          { type: 'heading', level: 2, content: 'Standard Deviation and Historical Volatility' },
          { type: 'text', content: '<strong>Volatility</strong> measures the degree of variation in an asset\'s price over time. It is the most common statistical measure of risk in finance and is typically expressed as the annualised standard deviation of returns. An asset with 80% annualised volatility (like Bitcoin historically) can be expected to move roughly 80% above or below its current price over the course of a year, one standard deviation of the time.' },
          { type: 'keyterm', term: 'Standard Deviation', definition: 'A statistical measure of dispersion. In finance, the standard deviation of an asset\'s returns quantifies how much returns deviate from their average. One standard deviation encompasses approximately 68% of observations (assuming a normal distribution), two standard deviations encompass 95%, and three standard deviations encompass 99.7%. Higher standard deviation equals higher volatility equals higher risk.' },
          { type: 'text', content: '<strong>Historical volatility</strong> (HV) is calculated from past price data. The standard approach: (1) calculate daily logarithmic returns, (2) compute the standard deviation of those returns over a window (e.g., 30 days), (3) annualise by multiplying by the square root of 252 (trading days per year) or 365 (for crypto, which trades 24/7). Bitcoin\'s 30-day HV has ranged from ~30% during quiet periods to 150%+ during crashes.' },
          { type: 'text', content: '<strong>Implied volatility</strong> (IV) is forward-looking — it is derived from options prices and represents the market\'s expectation of future volatility. When options traders expect larger price swings, IV increases. Bitcoin options on Deribit provide a rich dataset for IV analysis. The <strong>DVOL index</strong> (Deribit Volatility Index) is the crypto equivalent of the VIX.' },
          { type: 'callout', style: 'funfact', title: 'Bitcoin Volatility Is Declining', content: 'Bitcoin\'s annualised volatility has shown a secular downward trend: ~150-200% in 2011-2013, ~80-100% in 2017-2018, ~50-70% in 2021-2023. This decline is consistent with market maturation, increased institutional participation, and growing liquidity. If the trend continues, Bitcoin\'s volatility could converge toward gold-like levels (15-20%) within a decade, though this is speculative.' },
          { type: 'diagram', alt: 'Volatility Comparison Across Assets', description: 'A bar chart comparing annualised volatility across asset classes (approximate ranges). Bars from lowest to highest: U.S. Treasury Bonds (~5-8%), Gold (~15-20%), S&P 500 (~15-20%), Individual Tech Stocks (~30-50%), Bitcoin (~50-80%), Altcoins/Meme Coins (~100-200%). A horizontal dashed line at ~20% is labelled "Traditional high volatility threshold."' }
        ]
      },
      {
        id: 'sec-drawdowns',
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'Maximum Drawdown and Recovery' },
  ...
  // ═══════════════════════════════════════════════════════════════
  // COURSE 4 — COMPLIANCE & REGULATION
  // ═══════════════════════════════════════════════════════════════
  ...
  'lesson-mica': {
    sections: [
      {
        id: 'sec-mica-overview',
        title: 'What Is MiCA?',
        blocks: [
          { type: 'heading', level: 2, content: 'The EU\'s Markets in Crypto-Assets Regulation' },
          { type: 'text', content: 'The <strong>Markets in Crypto-Assets Regulation (MiCA)</strong> is the European Union\'s comprehensive regulatory framework for cryptocurrency and digital assets. Adopted in its final form in April 2023 and taking full effect on 30 December 2024, MiCA is the most extensive crypto-specific regulation enacted by any major economy. It establishes uniform rules across all 27 EU member states, replacing the patchwork of national regulations that previously existed.' },
          { type: 'text', content: 'MiCA was motivated by several factors: the need for consumer and investor protection (following losses from scams and platform failures), the desire for regulatory clarity to foster innovation within the EU, concerns about financial stability (particularly regarding stablecoins after the TerraUSD collapse in May 2022), and the goal of preventing regulatory arbitrage between EU member states.' },
          { type: 'keyterm', term: 'MiCA (Markets in Crypto-Assets)', definition: 'EU Regulation 2023/1114, a comprehensive legislative framework governing the issuance, offering, and provision of services related to crypto-assets in the European Union. MiCA covers three categories of crypto-assets: Asset-Referenced Tokens (ARTs), Electronic Money Tokens (EMTs), and other crypto-assets (utility tokens). It establishes licensing requirements for Crypto-Asset Service Providers (CASPs) and sets rules for stablecoin reserves, white paper disclosures, and market abuse prevention.' },
          { type: 'callout', style: 'info', title: 'MiCA Does Not Cover DeFi — Yet', content: 'MiCA explicitly excludes fully decentralised protocols (DeFi) that operate without an identifiable intermediary. However, the regulation requires the European Commission to report on the DeFi sector by 30 December 2024 and propose further legislation if necessary. The practical definition of "fully decentralised" remains ambiguous — protocols with governance tokens, foundation-controlled upgrade keys, or identifiable development teams may not qualify for the exemption.' },
          { type: 'text', content: 'MiCA classifies crypto-assets into three categories. <strong>Asset-Referenced Tokens (ARTs)</strong> are stablecoins pegged to multiple assets or commodities (e.g., a basket of currencies). <strong>Electronic Money Tokens (EMTs)</strong> are stablecoins pegged to a single fiat currency (e.g., USDC, USDT, EUROC). <strong>Other crypto-assets</strong> cover everything else — Bitcoin, Ethereum, utility tokens, meme coins, etc. Each category has different issuance requirements and regulatory obligations.' },
          { type: 'diagram', alt: 'MiCA Regulatory Scope', description: 'A Venn-style diagram showing what MiCA covers and excludes. Inside the MiCA scope: Crypto-Asset Service Providers (CASPs), Stablecoin issuers (ARTs and EMTs), Utility token issuers, Token offerings (white paper requirements). Outside the MiCA scope (explicitly excluded): Central Bank Digital Currencies (CBDCs), Security tokens (covered under MiFID II), NFTs that are truly unique (but fractionalised or fungible NFTs may be in scope), Fully decentralised DeFi protocols. A note indicates that the boundaries are still being interpreted by regulators.' }
        ]
      },
      {
        id: 'sec-mica-stablecoins',
        title: 'Stablecoin Regulation Under MiCA',
        blocks: [
          { type: 'heading', level: 2, content: 'Reserve Requirements and Limits' },
          { type: 'text', content: 'MiCA imposes stringent requirements on stablecoin issuers. <strong>EMT issuers</strong> (single-currency stablecoins) must be authorised as either an electronic money institution or a credit institution (bank) in the EU. They must maintain reserves equal to the token supply in secure, liquid assets. At least 30% of reserves must be held in deposits at credit institutions. The reserves must be segregated from the issuer\'s own assets and protected in the event of insolvency.' },
          { type: 'text', content: '<strong>ART issuers</strong> (multi-asset stablecoins) face similar reserve requirements plus additional restrictions. ARTs deemed "significant" (based on criteria including market capitalisation, transaction volume, and number of holders) face enhanced requirements including higher own-funds requirements, recovery and redemption plans, and oversight by the European Banking Authority (EBA) rather than national regulators.' },
          { type: 'keyterm', term: 'Significant Stablecoin', definition: 'Under MiCA, a stablecoin is classified as "significant" if it meets certain thresholds, including: more than 10 million holders, market capitalisation exceeding 5 billion EUR, daily transaction volume exceeding 500 million EUR, or significance for financial stability. Significant stablecoins face enhanced regulatory requirements and are supervised directly by the EBA. As of 2024, USDT and USDC would likely qualify as significant under these criteria.' },
          { type: 'callout', style: 'warning', title: 'The Daily Transaction Cap', content: 'MiCA includes a provision that non-euro-denominated EMTs cannot exceed 1 million transactions per day or 200 million EUR in daily transaction volume when used for payments within the EU. If these thresholds are exceeded, the issuer must take steps to reduce usage. This has raised concerns about the viability of USD-denominated stablecoins (USDT, USDC) for EU transactions and has prompted some exchanges to delist non-compliant stablecoins for EU users.' },
          { type: 'text', content: 'The stablecoin provisions were directly influenced by the collapse of <strong>TerraUSD (UST)</strong> in May 2022, which lost its dollar peg and wiped out approximately $40 billion in value. UST was an algorithmic stablecoin backed by the LUNA token rather than by real-world reserves — precisely the model that MiCA\'s reserve requirements are designed to prevent. The event accelerated the legislative process and hardened the stance against under-collateralised stablecoins.' },
          { type: 'activity', style: 'truefalse', title: 'MiCA and Stablecoins — True or False?', instructions: 'Test your understanding of EU crypto regulation.', items: [
            { statement: 'MiCA applies uniformly across all 27 EU member states.', answer: true },
            { statement: 'Algorithmic stablecoins with no reserve backing can be legally issued under MiCA.', answer: false },
            { statement: 'MiCA fully regulates decentralised DeFi protocols.', answer: false },
            { statement: 'EMT issuers must be authorised as electronic money institutions or credit institutions.', answer: true },
            { statement: 'MiCA classifies Bitcoin as an Asset-Referenced Token (ART).', answer: false }
          ]}
        ]
      },
      {
        id: 'sec-mica-casp',
        title: 'CASP Licensing and Global Impact',
        blocks: [
          { type: 'heading', level: 2, content: 'Operating a Crypto Business in the EU' },
          { type: 'text', content: 'Under MiCA, any entity providing crypto-asset services in the EU must obtain a <strong>Crypto-Asset Service Provider (CASP)</strong> licence from its home member state\'s national competent authority. CASP services include: operating a trading platform, custody and administration of crypto-assets, exchange of crypto for fiat or other crypto, execution of orders, placement of crypto-assets, providing advice, and portfolio management.' },
          { type: 'keyterm', term: 'CASP (Crypto-Asset Service Provider)', definition: 'A legal entity authorised under MiCA to provide one or more crypto-asset services in the EU. CASPs must meet requirements for corporate governance, capital adequacy, cybersecurity, complaint handling, conflict of interest management, and outsourcing. Once licensed in one EU member state, a CASP can "passport" its licence to operate across all 27 member states without additional authorisation — a significant advantage over the previous fragmented regime.' },
          { type: 'text', content: 'The <strong>passporting</strong> mechanism is one of MiCA\'s most significant features. Previously, a crypto exchange operating in Europe needed separate registrations in each country — a costly and time-consuming process. Under MiCA, a single CASP licence grants access to the entire EU market of over 440 million people and a combined GDP exceeding $15 trillion. This has attracted significant interest from global crypto firms seeking a European base of operations.' },
          { type: 'text', content: 'MiCA\'s global impact extends beyond the EU through the <strong>"Brussels Effect"</strong> — the tendency for EU regulations to become de facto global standards because multinational companies find it easier to adopt a single, strict standard rather than maintaining different practices for different markets. Japan, Brazil, the UK, and other jurisdictions have referenced MiCA when developing their own crypto regulations. The regulation is setting the template for how mature economies approach crypto oversight.' },
          { type: 'callout', style: 'tip', title: 'What MiCA Means for Traders', content: 'For individual crypto traders and investors in the EU, MiCA\'s practical effects include: (1) Enhanced consumer protections — CASPs must segregate client assets and maintain insurance. (2) White paper requirements — token issuers must publish clear disclosures before offerings. (3) Market abuse rules — insider trading and market manipulation in crypto are now explicitly illegal in the EU. (4) Some stablecoins may be delisted if issuers do not obtain EU authorisation. (5) Greater certainty about the legal status of crypto activities.' }
        ]
      }
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  // COURSE 5 — DERIVATIVES & LEVERAGE
  // ═══════════════════════════════════════════════════════════════

  'lesson-what-are-derivatives': {
    sections: [
      {
        id: 'sec-derivatives-intro',
        title: 'Introduction to Derivatives',
        blocks: [
          { type: 'heading', level: 2, content: 'Contracts Derived from Underlying Assets' },
  ...
  // ═══════════════════════════════════════════════════════════════
  // COURSE 6 — DATA ANALYSIS & INTERPRETATION
  // ═══════════════════════════════════════════════════════════════
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'activity', style: 'ordering', title: 'Source Reliability Ranking', instructions: 'Arrange these information sources from MOST reliable to LEAST reliable for making investment decisions.', items: [
            'SEC filing (10-K annual report) from the company itself',
            'Bloomberg or Reuters wire service news report',
            'Wall Street Journal analysis article',
            'Analysis by a known, transparent crypto analyst with a public track record',
            'Anonymous Twitter account promoting a specific token'
          ]}
        ]
      },
      {
  ...
  'lesson-da-key-terms': {
    sections: [
      ...
      },
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'The Most Important Chart in Finance' },
          { type: 'text', content: 'The <strong>yield curve</strong> plots the interest rates (yields) of U.S. Treasury bonds across different maturities, from 1-month to 30-year. In a normal environment, the curve slopes upward — longer-term bonds pay higher yields to compensate investors for the additional risk of tying up capital for longer. The yield curve is considered the most important chart in finance because its shape predicts economic conditions with remarkable accuracy.' },
          { type: 'keyterm', term: 'Yield Curve', definition: 'A graphical representation of interest rates (yields) across different bond maturities. A normal (upward-sloping) yield curve indicates healthy growth expectations. A flat yield curve suggests economic uncertainty. An inverted yield curve (short-term rates higher than long-term rates) has preceded every U.S. recession since 1955, with only one false signal (a brief inversion in 1966). The 2-year / 10-year spread is the most commonly watched measure.' },
          { type: 'text', content: 'An <strong>inverted yield curve</strong> occurs when short-term Treasury yields exceed long-term yields. The 2-year / 10-year Treasury spread inverted in July 2022 and remained inverted for over two years — the longest inversion since the 1970s. This inversion signalled that bond markets expected the Federal Reserve\'s aggressive interest rate hikes to slow economic growth significantly. The curve\'s un-inversion (steepening) is historically when recessions actually begin.' },
          { type: 'text', content: 'Interest rates affect all asset classes. <strong>Higher rates</strong> generally: increase the discount rate applied to future cash flows (lowering the present value of growth stocks), strengthen the dollar (pressuring gold and Bitcoin), increase the "hurdle rate" for risky investments, and make bonds more attractive relative to equities. <strong>Lower rates</strong> have the opposite effects and historically have been bullish for both stocks and crypto.' },
          { type: 'callout', style: 'info', title: 'Forward Guidance', content: 'The Federal Reserve communicates its policy intentions through "forward guidance" — statements about the likely future path of interest rates. The Fed\'s Summary of Economic Projections (SEP), which includes the "dot plot" of individual Fed members\' rate expectations, is closely watched. Markets often move more on changes in forward guidance than on the actual rate decision itself. The CME FedWatch tool shows market-implied probabilities for future rate decisions.' },
          { type: 'activity', style: 'truefalse', title: 'Financial Terms — True or False?', instructions: 'Test your knowledge of key market terms.', items: [
            { statement: 'A P/E ratio of 30 means investors are paying $30 for every $1 of annual earnings.', answer: true },
            { statement: 'An inverted yield curve has preceded every U.S. recession since 1955.', answer: true },
            { statement: 'A PEG ratio below 1.0 generally suggests a stock is overvalued relative to its growth.', answer: false },
            { statement: 'Higher interest rates are generally bullish for growth stocks and crypto.', answer: false },
            { statement: 'EPS stands for Earnings Per Share and equals net income divided by outstanding shares.', answer: true }
          ]}
        ]
      },
      {
        id: 'sec-market-language',
        title: 'Market Language and Jargon',
        blocks: [
          { type: 'heading', level: 2, content: 'Speaking Like a Market Professional' },
          { type: 'text', content: 'Beyond valuation metrics, financial reports are filled with specialised terminology. <strong>Basis points (bps)</strong> are hundredths of a percentage point (100 bps = 1%). Interest rate moves are expressed in basis points: "The Fed raised rates by 25 basis points" means rates increased by 0.25%. <strong>Hawkish</strong> describes a central bank bias toward tighter monetary policy (higher rates); <strong>dovish</strong> describes a bias toward easier policy (lower rates).' },
          { type: 'text', content: '<strong>Alpha</strong> is the excess return above a benchmark (e.g., a hedge fund that returns 15% when the S&P returns 10% generated 5% alpha). <strong>Beta</strong> measures an asset\'s sensitivity to market movements (a beta of 1.5 means the asset moves 50% more than the market). <strong>Sharpe ratio</strong> measures risk-adjusted return: (Return - Risk-Free Rate) / Standard Deviation. A Sharpe above 1.0 is considered good; above 2.0 is excellent.' },
          { type: 'keyterm', term: 'Sharpe Ratio', definition: 'A measure of risk-adjusted performance calculated as (Portfolio Return - Risk-Free Rate) / Portfolio Standard Deviation. Developed by William Sharpe (Nobel Prize 1990). A Sharpe ratio of 1.0 means the portfolio earns 1 unit of excess return per unit of risk. The S&P 500 has a long-term Sharpe ratio of approximately 0.4-0.5. Hedge funds typically target Sharpe ratios of 1.0-2.0. Bitcoin\'s Sharpe ratio has varied widely but has been positive over most multi-year periods.' },
          { type: 'text', content: 'Other essential terms: <strong>Market capitalisation</strong> (share price x outstanding shares — "large cap" is generally >$10B, "mid cap" $2-10B, "small cap" <$2B). <strong>Liquidity</strong> (how easily an asset can be bought or sold without significantly affecting the price). <strong>Spread</strong> (the difference between bid and ask prices). <strong>Volume</strong> (the total number of shares or contracts traded in a period — higher volume generally indicates stronger conviction behind a price move).' },
          { type: 'callout', style: 'funfact', title: 'Why Jargon Matters', content: 'Market jargon is not just about sounding sophisticated — it enables precise, efficient communication. When a Bloomberg terminal headline reads "10Y UST yields +5bps to 4.32%, curve steepening, hawkish Fed Dot Plot revision," an experienced trader instantly understands: 10-year Treasury yields rose 0.05% to 4.32%, long-term rates are rising faster than short-term rates, and the Federal Reserve signalled higher rates for longer. Without the vocabulary, this critical information is inaccessible.' }
        ]
      }
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  // COURSE 7 — WEALTH MANAGEMENT & TAX OPTIMIZATION (TYCOON GATE)
  // ═══════════════════════════════════════════════════════════════

  'lesson-wm-corporate-structures': {
    sections: [
      {
        id: 'sec-wm-why-structure',
        title: 'Why Corporate Structure Matters',
        blocks: [
          { type: 'heading', level: 2, content: 'Your Wealth Needs a Legal Home' },
          { type: 'text', content: 'When you earn significant money — from trading, investing, or any business activity — the legal structure you operate through determines <strong>how much tax you pay</strong>, <strong>who can seize your assets if things go wrong</strong>, and <strong>what happens to your wealth when you die or retire</strong>. Most people default to operating as individuals. This is the most dangerous and expensive option.' },
          { type: 'callout', style: 'warning', title: 'The Unincorporated Trap', content: 'Operating without a legal structure means your personal assets — your home, savings, car — are directly exposed to any business liability. A single lawsuit, bad trade, or debt can wipe everything out. The government also taxes you at the highest personal income tax rates. This is why high earners almost universally incorporate.' },
          { type: 'keyterm', term: 'Corporate Structure', definition: 'The legal entity type through which a person or group conducts business. Common structures include Sole Proprietorships, Partnerships, Limited Liability Companies (LLCs), and Corporations. Each has different rules for taxation, liability, ownership, and governance.' },
          { type: 'text', content: 'In this lesson, you will learn all six major structures — from the simplest (Sole Trader) to the most powerful (Publicly Held Corporation). You will understand exactly what each structure protects, what it costs, and which is right for each stage of your financial journey.' }
        ]
      },
      {
        id: 'sec-wm-sole-partnership',
        title: 'Sole Trader & Partnership',
        blocks: [
          { type: 'heading', level: 2, content: 'Unlimited Liability Structures' },
          ...
          { type: 'keyterm', term: 'Unlimited Liability', definition: 'A legal condition where the owner is personally responsible for all business debts and obligations. There is no legal "firewall" between personal and business assets. If the business fails or incurs debts beyond its assets, creditors can seize the owner\'s personal property.' },
          ...
          { type: 'callout', style: 'warning', title: 'Joint and Several Liability', content: 'In a general partnership, "joint and several liability" means each partner can be held fully responsible for the entire partnership\'s obligations. If Partner A disappears or is insolvent, creditors can collect 100% of the debt from Partner B alone. This makes general partnerships extremely risky without a carefully drafted partnership agreement and professional liability insurance.' },
          { type: 'activity', style: 'truefalse', title: 'Sole Trader & Partnership', instructions: 'True or false?', items: [
            { statement: 'A sole trader\'s personal home can be seized to cover business debts.', answer: true },
            { statement: 'A partnership always protects each partner\'s personal assets.', answer: false },
            { statement: 'Setting up as a sole trader typically costs nothing.', answer: true },
            { statement: 'In a general partnership, one partner can be liable for another partner\'s mistakes.', answer: true }
          ]}
        ]
      },
      {
        id: 'sec-wm-companies',
        title: 'Limited Liability Companies & Corporations',
        blocks: [
          { type: 'heading', level: 2, content: 'The Corporate Firewall' },
  ...
  'lesson-wm-tax-strategies': {
    sections: [
      {
        id: 'sec-wm-tax-burden',
        title: 'The Tax Burden Reality',
        blocks: [
          { type: 'heading', level: 2, content: 'How Much Are You Actually Paying?' },
          { type: 'text', content: 'Most individual earners face marginal income tax rates of 30–50% in developed economies. On top of income tax, capital gains tax applies to investment profits, self-employment tax applies to business income, and wealth taxes exist in some jurisdictions. A trader earning €100,000 as an individual might pay €35,000–€50,000 in taxes. The same trader operating through a correctly structured company might pay €10,000–€15,000.' },
          { type: 'callout', style: 'warning', title: 'The Unincorporated Tax Trap in This Game', content: 'Without any corporate structure, you are taxed at 30% on your net worth above €10,000 every fiscal cycle. This is intentionally punishing — just as in real life, governments impose their highest rates on unstructured income. Incorporating as a Sole Trader drops this to 25%. An LLC drops it to 10%. A Public Company gets you to 5%.' },
          { type: 'keyterm', term: 'Effective Tax Rate', definition: 'The actual percentage of total income paid in taxes, accounting for deductions, credits, and structure. Contrasted with the marginal rate (the rate on the last dollar of income). A corporation with a 21% statutory rate might have an effective rate of 12–15% after deductions.' },
          { type: 'text', content: 'The strategy is not to evade taxes — that is illegal — but to legally structure your affairs to qualify for the lowest applicable rate. This is called <strong>tax optimisation</strong> or <strong>tax efficiency</strong>, and it is the primary reason every major wealth holder incorporates.' }
        ]
      },
      {
        id: 'sec-wm-optimization',
        title: 'Legal Optimisation Tactics',
        blocks: [
          { type: 'heading', level: 2, content: 'The Wealth Builder\'s Tax Toolkit' },
          { type: 'text', content: '<strong>Holding Company Structures:</strong> Instead of owning assets personally, a holding company owns everything. The holding company receives dividends, capital gains, and rent at corporate tax rates (much lower than personal rates), then distributes to subsidiaries or reinvests. Wealthy families use holding companies to centralise asset ownership, reduce taxes, and facilitate estate planning.' },
          { type: 'text', content: '<strong>Income Splitting:</strong> Directing income to family members or entities in lower tax brackets reduces the overall tax burden. A sole trader earning €300k pays 45% on the top bracket. The same income split among three family members might never breach the 25% bracket.' },
          { type: 'keyterm', term: 'Tax-Loss Harvesting', definition: 'Selling investments at a loss to realise a capital loss that offsets capital gains. If you have €20,000 in gains and €8,000 in unrealised losses, selling the losing position reduces net taxable gains to €12,000. The loss position can often be repurchased immediately (unlike stocks, which have wash-sale rules in many jurisdictions).' },
          { type: 'callout', style: 'tip', title: 'Jurisdiction Matters', content: 'Corporate tax rates vary wildly by country: Ireland (12.5%), UAE (9%), UK (25%), France (25%), USA (21% federal + state). Trading platforms operating through Irish or UAE holding structures can achieve dramatically lower effective tax rates than competitors in high-tax jurisdictions. This is legal. It is why Apple\'s Irish subsidiary became infamous.' },
          { type: 'activity', style: 'truefalse', title: 'Tax Strategy', instructions: 'True or false?', items: [
            { statement: 'Tax avoidance is illegal.', answer: false },
            { statement: 'Tax evasion involves hiding income from authorities.', answer: true },
            { statement: 'A holding company structure can reduce total tax paid on investment income.', answer: true },
            { statement: 'Tax-loss harvesting always results in a permanent loss of capital.', answer: false }
          ]}
        ]
      },
      {
        id: 'sec-wm-game-mechanics',
        title: 'Tax Strategy in the Game',
        blocks: [
          { type: 'heading', level: 2, content: 'How Structure Changes Your Tax Rate' },
          { type: 'text', content: 'In Quantico, your corporate structure directly determines your tax rate during fiscal cycles. Operating without a structure exposes you to the maximum 30% rate every 20 price ticks. As you incorporate, that rate drops dramatically:' },
          { type: 'diagram', alt: 'Tax Rate by Structure', description: 'Table: Structure | Tax Rate | Liability. None (Unincorporated) | 30% | Unlimited. Sole Trader | 25% | Unlimited. Partnership | 25% | Unlimited. Privately Held (LLC) | 10% | Limited. Publicly Held | 5% | Limited. Social Enterprise | 3% | Limited. NGO | 0% | Limited.' },
          { type: 'text', content: 'The €50,000 setup cost for an LLC might seem large, but consider: if your net worth is €200,000, the unincorporated 30% tax on €190,000 taxable income is €57,000 per cycle. The LLC rate of 10% is €19,000 — a saving of €38,000 per cycle. The setup cost is recovered in less than two fiscal cycles.' },
          { type: 'callout', style: 'funfact', title: 'The LLC Calculus', content: 'Assuming a net worth of €200,000 and a fiscal cycle every 3 minutes: Unincorporated rate (30%) = €57,000 tax. LLC rate (10%) = €19,000 tax. Saving per cycle: €38,000. LLC setup cost: €50,000. Payback period: 1.3 fiscal cycles (≈4 minutes). The math is overwhelming in favour of incorporating as soon as you can afford it.' }
        ]
      }
    ]
  },
  ...
  'lesson-wm-asset-protection': {
    sections: [
      {
        id: 'sec-wm-liability-explained',
        title: 'Understanding Liability',
        blocks: [
          { type: 'heading', level: 2, content: 'What Can You Lose?' },
          { type: 'text', content: 'Liability is the legal obligation to pay a debt or fulfil a duty. In a financial context, it means: if your trading strategy fails spectacularly and you owe more than your trading account holds, <em>what else can creditors take from you?</em> The answer depends entirely on your corporate structure.' },
          { type: 'text', content: '<strong>Unlimited liability</strong> structures (Sole Trader, General Partnership): every asset you personally own is on the table. Your home, car, savings account, family heirlooms — all fair game for creditors. There is no legal firewall protecting them.' },
          { type: 'text', content: '<strong>Limited liability</strong> structures (LLC, Corporation, Social Enterprise, NGO): creditors can only claim the assets inside the legal entity. If your company goes bankrupt with €500,000 in debt and only €50,000 in assets, creditors receive €50,000 and you walk away personally intact — keeping whatever is in your personal accounts.' },
          { type: 'keyterm', term: 'Bankruptcy', definition: 'A legal process by which individuals or entities that cannot repay debts seek relief from creditors. For unlimited liability structures, personal bankruptcy can follow business bankruptcy, forcing liquidation of all personal assets. For limited liability structures, corporate bankruptcy does not automatically affect personal finances.' }
        ]
      },
      {
        id: 'sec-wm-protecting-assets',
        title: 'Protecting Your Assets',
        blocks: [
          { type: 'heading', level: 2, content: 'Multiple Layers of Protection' },
          { type: 'text', content: 'Sophisticated wealth builders do not rely on a single layer of protection. They stack multiple defensive structures: (1) <strong>LLC or Corporation</strong> as the operating entity — creates the primary firewall. (2) <strong>Holding Company</strong> that owns the LLC — adds another separation layer. (3) <strong>Insurance</strong> (liability, professional indemnity, umbrella) — covers risks that pierce through corporate structures.' },
          { type: 'callout', style: 'tip', title: 'The "Corporate Veil" Is Fragile', content: 'Courts will "pierce the corporate veil" and hold you personally liable if: you commingle personal and business funds, fail to maintain corporate formalities (no board meetings, no separate accounts), use the company to commit fraud, or personally guarantee business debts. The protection only exists if you respect the legal separation.' },
          { type: 'keyterm', term: 'Holding Company', definition: 'A company that does not produce goods or services itself but instead owns shares in other companies (subsidiaries). Assets held by the holding company are separate from operations — if an operating subsidiary faces liability, the holding company\'s other assets are protected.' },
          { type: 'text', content: 'In this game, when your trading company (the LLC) goes bankrupt, your personal savings are protected — but your company\'s city buildings are liquidated. You receive back 50% of their construction value as "scrap value." This mirrors real-world limited liability: you lose your business investment but keep your personal wealth separate from the company.' },
          { type: 'activity', style: 'truefalse', title: 'Asset Protection', instructions: 'True or false?', items: [
            { statement: 'An LLC completely eliminates all personal financial risk.', answer: false },
            { statement: 'Commingling personal and business funds can remove LLC protection.', answer: true },
            { statement: 'A holding company structure adds an additional layer of liability protection.', answer: true },
            { statement: 'If your LLC goes bankrupt, creditors can automatically seize your personal home.', answer: false }
          ]}
        ]
      },
      {
        id: 'sec-wm-structuring-wealth',
        title: 'Structuring for Long-Term Wealth',
        blocks: [
          { type: 'heading', level: 2, content: 'The Empire Architecture' },
          { type: 'text', content: 'The ultimate wealth preservation structure looks like this: A <strong>Personal Trust or Family Office</strong> sits at the top, holding assets for the long term. Below it, a <strong>Holding Company</strong> owns multiple operating subsidiaries. Each subsidiary operates in a specific domain: one for trading, one for real estate, one for private equity investments. If any subsidiary fails, the others are unaffected.' },
          { type: 'text', content: 'This is exactly what successful entrepreneurs build after their first major liquidity event. Jeff Bezos, Elon Musk, and most billionaires operate through a web of holding companies, trusts, and LLCs — not as individuals. The structure is not about hiding money; it is about <em>protecting</em> what they have built.' },
          { type: 'callout', style: 'funfact', title: 'Your Empire in This Game', content: 'As you progress through Quantico, you will unlock the ability to change your corporate structure as your net worth grows. Each structure change reduces your tax rate and changes how bankruptcy affects your city. The goal: reach Public Company status with billions in assets, a fully built city, and hostile takeover defenses ready. This is the endgame.' },
          { type: 'text', content: 'Passing this course exam unlocks the HQ Incorporation Modal — where you can choose your first corporate structure and dramatically reduce your tax burden. Every €10,000 you earn after incorporating is a direct reflection of the knowledge you just gained. This is wealth management made real.' }
        ]
      }
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  // PHASE 4 — MACRO MARKETS: COMMODITIES, FOREX & BONDS
  // ═══════════════════════════════════════════════════════════════
    ...
    sections: [
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'The Raw Materials That Power Civilisation' },
          { type: 'text', content: 'Commodities are the raw materials and primary agricultural products that form the foundation of the global economy. They fall into three broad categories: <strong>energy</strong> (crude oil, natural gas, coal), <strong>metals</strong> (gold, silver, copper, aluminium), and <strong>agricultural products</strong> (wheat, corn, soybeans, sugar). Unlike stocks — which represent ownership in a company — commodities are physical goods that can be stored, transported, and consumed.' },
          { type: 'keyterm', term: 'Hard vs Soft Commodities', definition: 'Hard commodities are mined or extracted from the earth: gold, oil, copper, iron ore. Soft commodities are grown: wheat, coffee, cotton, cocoa. The distinction matters because soft commodities face weather and disease risks that hard commodities do not.' },
          { type: 'text', content: 'The global commodities market trades approximately <strong>$5-7 trillion per day</strong> when including derivatives. Physical delivery is rare for retail traders — most participants trade futures contracts that give the right to buy or sell at a set price on a future date, settling the difference in cash. Chicago Mercantile Exchange (CME) and Intercontinental Exchange (ICE) are the two dominant global hubs.' },
          { type: 'callout', style: 'info', title: 'The Commodity Supercycle', content: 'History shows commodities move in long "supercycles" lasting 10-20 years. The 1999-2008 cycle was driven by Chinese industrialisation — China\'s steel demand alone moved iron ore prices 500%. The next cycle may be driven by the energy transition: copper, lithium, cobalt, and rare earths are all critical inputs for electric vehicles and solar panels.' }
        ]
      },
      {
        id: 'sec-mm-comm-drivers',
        title: 'What Moves Commodity Prices',
        blocks: [
          { type: 'heading', level: 2, content: 'Supply, Demand, and Geopolitics' },
          { type: 'text', content: 'Three forces dominate commodity prices: <strong>supply shocks</strong>, <strong>demand shifts</strong>, and <strong>currency effects</strong>. Since most commodities are priced in US Dollars, a strong dollar makes them more expensive for foreign buyers, suppressing demand and prices. A weak dollar does the opposite.' },
          { type: 'text', content: '<strong>Supply shocks</strong> are often sudden: OPEC production cuts (oil), severe droughts (wheat, corn), mine strikes or accidents (copper, gold), or geopolitical conflict disrupting shipping lanes. The 2022 Russia-Ukraine war immediately spiked wheat prices 40% and European natural gas prices 300% — Russia and Ukraine together supply 28% of global wheat exports.' },
          { type: 'callout', style: 'warning', title: 'Contango vs Backwardation', content: 'Futures curves can be in "contango" (future price > spot price, normal for storable commodities with storage costs) or "backwardation" (future price < spot price, signalling immediate scarcity). Oil was in historic backwardation in 2022, with spot WTI at $120 while 2-year futures were $80 — traders expected supply to normalise. This is a powerful signal for experienced traders.' },
          { type: 'keyterm', term: 'Futures Contract', definition: 'A standardised agreement to buy or sell a specific commodity at a predetermined price on a future date. For example, one WTI crude oil futures contract (CL) represents 1,000 barrels. CME gold futures (GC) represent 100 troy ounces. Retail traders rarely take delivery — they "roll" contracts or close positions before expiry.' },
          { type: 'activity', style: 'truefalse', title: 'Commodity Basics', instructions: 'Commodity markets knowledge check:', items: [
            { statement: 'A strong US Dollar typically pushes commodity prices higher for foreign buyers.', answer: false },
            { statement: 'Oil, gold, and copper are classified as "hard" commodities.', answer: true },
            { statement: 'Most retail commodity traders take physical delivery of their contracts.', answer: false },
            { statement: 'Backwardation in futures markets signals immediate scarcity of supply.', answer: true }
          ]}
        ]
      },
      {
        id: 'sec-mm-comm-game',
        title: 'Commodities in Your Portfolio',
        blocks: [
          { type: 'heading', level: 2, content: 'Trading Gold, Oil, and More' },
          { type: 'text', content: 'In Quantico, commodities trade at simulated real-world prices with realistic volatility: oil is the most volatile (1.5% per tick), natural gas most erratic (2% per tick), while gold is steadier (0.8% per tick) and acts as a safe haven during market stress events.' },
          { type: 'callout', style: 'tip', title: 'Portfolio Role of Commodities', content: 'Commodities have historically low correlation with stocks and bonds. Adding 5-15% commodities to a portfolio reduces volatility without sacrificing returns — the "free lunch" of diversification. Gold specifically has a near-zero or negative correlation with equities during crises: when the 2008 financial crash wiped 50% off stock markets, gold rose 25%.' },
          { type: 'text', content: 'Key metric to watch in Quantico\'s commodities market: the news event panel. When a "Middle East supply disruption" event fires, oil and natural gas receive a positive price bias for 3-4 ticks. Positioning ahead of or immediately after these events is the primary edge in commodity trading.' }
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: '$7.5 Trillion Per Day' },
          { type: 'text', content: 'The foreign exchange market — Forex or FX — is the largest and most liquid financial market on Earth, with average daily trading volume exceeding <strong>$7.5 trillion</strong> (BIS Triennial Survey, 2022). It operates 24 hours a day, five days a week, as trading passes from the Sydney session (Asia-Pacific) to Tokyo, then London, then New York. There is no centralised exchange — trades occur over-the-counter between banks, brokers, and institutions.' },
          { type: 'keyterm', term: 'Currency Pair', definition: 'Forex is always quoted as a pair: the base currency vs the quote currency. EUR/USD = 1.085 means 1 Euro buys 1.085 US Dollars. The first currency (EUR) is always what you are buying or selling; the second (USD) is the pricing currency. "Buying EUR/USD" means buying Euros and simultaneously selling Dollars.' },
          { type: 'text', content: 'The four most traded pairs — EUR/USD, USD/JPY, GBP/USD, and USD/CHF — are called the "majors" and make up over 70% of all Forex volume. They have the tightest bid-ask spreads, deepest liquidity, and most reliable technical behaviour. Pairs not involving the USD (EUR/GBP, EUR/JPY) are called "cross rates" or simply "crosses."' },
          { type: 'callout', style: 'funfact', title: 'The Swiss Franc Shock (2015)', content: 'On January 15, 2015, the Swiss National Bank unexpectedly removed the EUR/CHF floor it had maintained at 1.20. In seconds, EUR/CHF crashed from 1.20 to 0.86 — a 28% move in minutes. It was the largest single-day move in a major currency pair in modern history. Several retail Forex brokers went bankrupt because clients lost more than their account balances. This event illustrates why leverage in Forex can be catastrophic.' }
        ]
      },
      {
        id: 'sec-mm-fx-rates',
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'Interest Rates, Inflation, and Market Sentiment' },
          { type: 'text', content: 'The primary driver of long-term exchange rates is <strong>interest rate differentials</strong>. When the US Federal Reserve raises rates while the European Central Bank holds, capital flows into the US to earn higher yields, buying USD and selling EUR, pushing EUR/USD lower. This "carry trade" — borrowing in low-rate currencies to invest in high-rate ones — generates massive institutional flows.' },
          { type: 'keyterm', term: 'Purchasing Power Parity (PPP)', definition: 'The long-run theory that exchange rates should move to equalise the purchasing power of currencies. If a basket of goods costs €100 in Germany and $115 in the US, PPP predicts EUR/USD should be 1.15. While PPP rarely holds short-term (due to capital flows, sentiment, and speculation), it is a useful anchor for assessing currency over- or under-valuation over years.' },
          { type: 'text', content: 'Short-term drivers include: <strong>economic data releases</strong> (US Non-Farm Payrolls can move EUR/USD 100+ pips in a minute), <strong>central bank forward guidance</strong> (hawkish vs dovish language), <strong>geopolitical risk</strong> (wars, political instability push capital into "safe haven" currencies: USD, CHF, JPY), and <strong>risk sentiment</strong> (when markets fear a recession, the USD typically strengthens as global investors seek dollar liquidity).' },
          { type: 'callout', style: 'warning', title: 'Leverage Is a Double-Edged Sword', content: 'Retail Forex brokers offer leverage up to 50:1 in the US, up to 30:1 in the EU (ESMA regulation). At 30:1 leverage, a 3.33% adverse move wipes your entire position. In the context of currency markets where a 1-2% daily move is considered large, this sounds manageable — but news shocks like the 2015 SNB event or unexpected Fed decisions can cause 3-5% moves in minutes. Professional Forex traders rarely use more than 5-10:1 effective leverage.' }
        ]
      },
      {
        id: 'sec-mm-fx-game',
        title: 'Forex in Quantico',
        blocks: [
          { type: 'heading', level: 2, content: 'EUR/USD, GBP/USD, USD/JPY, USD/CHF' },
          { type: 'text', content: 'Quantico simulates four major currency pairs with realistic tight spreads and lower volatility (0.3-0.5% per tick) compared to commodities or crypto. Forex requires larger position sizes to generate meaningful returns, but is the most stable market in the simulator.' },
          { type: 'text', content: 'Watch for the "Central bank intervenes in EUR/USD" news event — this triggers a sharp 4% directional move with a 2-tick decay. The USD/CHF pair is the safest (lowest volatility at 0.3%), making it suitable for defensive capital parking while waiting for other market opportunities.' },
          { type: 'callout', style: 'tip', title: 'The Yen Carry Trade', content: 'USD/JPY is a popular carry trade: borrow yen at near-zero Japanese interest rates, invest in USD assets at higher US rates. The trade unwinds violently when risk sentiment shifts — USD/JPY can drop 5-10% in days during global market panics as yen loans get recalled. In Quantico, USD/JPY has the highest volatility among the forex pairs (0.5% per tick) for this reason.' }
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        title: 'The Macro Web',
        blocks: [
          { type: 'heading', level: 2, content: 'How Global Markets Are Interconnected' },
          { type: 'text', content: 'Financial markets are not isolated — they form a complex, interdependent web where moves in one asset class ripple through others. Understanding these connections is the difference between reacting to market moves and anticipating them. The central thread: <strong>US interest rates and the US Dollar</strong>.' },
          { type: 'text', content: 'Trace the chain: The Federal Reserve raises rates → US Treasuries yield more → capital flows into USD-denominated assets → USD strengthens → commodity prices fall (dollar-priced goods cost more for foreign buyers) → emerging market currencies weaken (they borrowed in USD, now repayments are more expensive) → EM stocks sell off → US stocks also sell off as higher rates reduce the present value of future earnings → gold falls initially (competing with yield-bearing assets) but may later rise as recession fears mount.' },
          { type: 'callout', style: 'info', title: 'Oil and the Everything Chain', content: 'Oil is the commodity with the most far-reaching macro connections. Rising oil prices increase inflation → central banks must hike rates → rates crush growth-sensitive assets → commodities may sell off as recession fears replace inflation fears → the cycle reverses. This is why oil traders need to be macro traders. The 2022 commodity cycle was a textbook example: oil spiked to $130 on Russia-Ukraine fears, then crashed to $70 as rate hike recession fears took over.' }
        ]
      },
      {
        id: 'sec-mm-conn-flight',
        title: 'Risk-On vs Risk-Off',
        blocks: [
          { type: 'heading', level: 2, content: 'The Market\'s Fear Gauge' },
          { type: 'text', content: 'Markets operate in two broad psychological states. In <strong>risk-on</strong> mode, investors are confident: they buy stocks, high-yield bonds, emerging market currencies, and cyclical commodities like copper and oil. In <strong>risk-off</strong> mode, fear dominates: they flee to US Treasuries, the Swiss Franc, Japanese Yen, gold, and cash.' },
          { type: 'keyterm', term: 'Safe-Haven Assets', definition: 'Assets that tend to hold or increase value during market turmoil due to their perceived safety, liquidity, or low correlation with risk assets. Primary safe havens: US Treasury bonds, gold, USD, CHF, and JPY. Secondary safe havens: Swiss real estate, German Bunds. The safe-haven status of gold is particularly strong — it spiked 25% in the 2008 crisis when global stocks fell 50%.' },
          { type: 'text', content: 'The VIX index (CBOE Volatility Index) measures expected stock market volatility. Above 30 signals high fear (risk-off). Below 15 signals complacency (risk-on). When the VIX spikes, expect: bonds up, USD up, CHF up, JPY up, gold up, and everything else down. This is the classic "dash for cash and safety" pattern seen in every crisis from 2008 to 2020 to 2022.' },
          { type: 'callout', style: 'tip', title: 'Using This in Quantico', content: 'When a negative news event fires in Quantico (recession fears, oil disruption, housing regulations), look for cross-market opportunities. Bonds and gold may rally even as oil or real estate sells off. The "Recession fears mount" event applies downward pressure to oil and copper but upward pressure to bonds — try trading both directions simultaneously across the sim markets.' }
        ]
      }
    ]
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  // PHASE 4 — TANGIBLE ASSETS: REAL ESTATE & PHYSICAL MARKETS
  // ═══════════════════════════════════════════════════════════════
  ...
  'lesson-ta-reits': {
    sections: [
      {
        id: 'sec-ta-reit-what',
        title: 'REITs — Real Estate Without the Building',
        blocks: [
          { type: 'heading', level: 2, content: 'Liquid Real Estate at Scale' },
  ...
  // ═══════════════════════════════════════════════════════════════
  // PHASE 4 — CORPORATE FINANCE: M&A, PE, VC & HEDGE FUNDS
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // ECFL PROFESSIONAL CERTIFICATION CONTENT (F2 & F3)
  // Exclusively for the ECFL certification track.
  // NOT linked to in-game textbook courses.
  // F2 = GMAT Quantitative level; F3 = CFA Level 1-2 level
  // ═══════════════════════════════════════════════════════════════
    ...
    sections: [
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'Balance Sheet, Income Statement, and Cash Flow Statement' },
          { type: 'text', content: 'Every public company is required to produce three core financial statements each quarter. Together they provide a complete picture of a company\'s financial health: what it owns and owes (<strong>Balance Sheet</strong>), how much it earned (<strong>Income Statement</strong>), and how cash actually moved (<strong>Cash Flow Statement</strong>). Professional investors read all three together — relying on any single statement in isolation is a common analytical error.' },
          { type: 'heading', level: 3, content: 'The Balance Sheet (Statement of Financial Position)' },
          { type: 'text', content: 'The balance sheet captures the financial position at a single point in time. It is governed by the fundamental accounting equation: <strong>Assets = Liabilities + Shareholders\' Equity</strong>. Assets are resources the company controls (cash, receivables, inventory, property, intangibles). Liabilities are obligations (accounts payable, debt, deferred revenue). Equity is the residual interest of shareholders after liabilities are subtracted from assets.' },
          { type: 'keyterm', term: 'Working Capital', definition: 'Current Assets minus Current Liabilities. A positive figure means the company has enough short-term assets to cover short-term obligations. Negative working capital is a red flag indicating potential liquidity stress. Amazon famously operates with negative working capital (customers pay upfront; suppliers are paid later) — this is a deliberate structural advantage, not a weakness.' },
          { type: 'heading', level: 3, content: 'The Income Statement (P&L)' },
          { type: 'text', content: 'The income statement covers a period (quarter or year) and shows: <strong>Revenue</strong> (top line) → COGS deducted → <strong>Gross Profit</strong> → Operating expenses deducted → <strong>EBIT</strong> (Earnings Before Interest and Tax) → Interest expense → EBT → Tax → <strong>Net Income</strong> (bottom line). EBITDA (EBIT + Depreciation + Amortisation) is the most widely used proxy for operating cash flow, though analysts increasingly rely on actual free cash flow.' },
          { type: 'heading', level: 3, content: 'The Cash Flow Statement' },
          { type: 'text', content: 'The cash flow statement reconciles net income to actual cash generated in three sections: <strong>Operating Cash Flow</strong> (core business cash generation — the most important figure), <strong>Investing Cash Flow</strong> (capex, acquisitions, asset sales — usually negative for growing companies), and <strong>Financing Cash Flow</strong> (debt issuance/repayment, equity issuance, dividends, buybacks). A company can report net income while burning cash — this divergence (accrual vs. cash) is where frauds and crises hide.' },
          { type: 'callout', style: 'warning', title: 'Accrual vs. Cash Accounting', content: 'Under accrual accounting, revenue is recognised when earned, not when cash is received. A company can book $10M revenue in Q3 but not collect the cash until Q1 the following year. This creates "channel stuffing" fraud risk: companies ship product to distributors with generous return policies to inflate reported revenue. Enron\'s collapse in 2001 was partly enabled by aggressive accrual accounting that made earnings appear far higher than underlying cash flows suggested.' }
        ]
      },
      {
        id: 'sec-ratio-analysis',
        title: 'Financial Ratio Analysis',
        blocks: [
          { type: 'heading', level: 2, content: 'Reading the Numbers Behind the Numbers' },
          { type: 'text', content: 'Raw financial statements are difficult to compare across companies of different sizes. Ratios standardise the data, enabling meaningful comparison. Professional analysts group ratios into four categories: <strong>Liquidity</strong> (can it pay short-term bills?), <strong>Profitability</strong> (how efficiently does it generate earnings?), <strong>Leverage</strong> (how much debt risk does it carry?), and <strong>Efficiency</strong> (how well does it use its assets?).' },
          { type: 'keyterm', term: 'Current Ratio', definition: 'Current Assets / Current Liabilities. Measures short-term liquidity. Above 2.0x is generally considered safe; below 1.0x indicates the company may struggle to meet near-term obligations. However, sector context matters — supermarkets routinely operate at 0.7-0.9x due to fast inventory turnover.' },
          { type: 'keyterm', term: 'Return on Equity (ROE)', definition: 'Net Income / Shareholders\' Equity. Measures how effectively management generates profits from shareholders\' capital. The DuPont decomposition breaks ROE into three drivers: Profit Margin x Asset Turnover x Financial Leverage. A high ROE driven purely by high leverage (debt) is less sustainable than one driven by superior margins or asset efficiency.' },
          { type: 'keyterm', term: 'Debt/EBITDA', definition: 'Total Debt / EBITDA. The single most important leverage ratio in leveraged finance and credit analysis. Investment-grade companies typically maintain Debt/EBITDA below 3.0x. Above 5.0x is considered highly leveraged. Private equity buyouts often close at 6-8x, with the expectation that debt is repaid from operating cash flow over 5-7 years.' },
          { type: 'text', content: 'The <strong>DuPont Analysis</strong> decomposes ROE = (Net Income/Revenue) x (Revenue/Assets) x (Assets/Equity). This is powerful because it identifies the source of ROE. Apple\'s ROE of ~180% is exceptional because it operates with negative book equity (aggressive buybacks), not just because of high margins. A telecom\'s 15% ROE might come mostly from financial leverage, not operational excellence. The same ROE can signal very different business quality.' }
        ]
      },
      {
        id: 'sec-dcf-valuation',
        title: 'Discounted Cash Flow Valuation',
        blocks: [
          { type: 'heading', level: 2, content: 'The Intrinsic Value Framework' },
          { type: 'text', content: 'The DCF model is the theoretical foundation of all fundamental valuation. The principle: a company is worth the present value of all future free cash flows it will generate, discounted at a rate that reflects the risk of those cash flows. Every other valuation method (multiples, precedent transactions) is ultimately a shortcut that approximates DCF under different assumptions.' },
          { type: 'keyterm', term: 'Free Cash Flow to Firm (FCFF)', definition: 'EBIT(1-T) + Depreciation - Capital Expenditure - Change in Working Capital. This is the cash available to all capital providers (both debt and equity holders) after operating expenses and reinvestment requirements. FCFF is the correct cash flow to use when computing enterprise value. FCFE (Free Cash Flow to Equity) subtracts net debt repayment and is used to value equity directly.' },
          { type: 'keyterm', term: 'WACC', definition: 'Weighted Average Cost of Capital = (E/V)xRe + (D/V)xRdx(1-T). The blended cost of a company\'s capital, weighted by its capital structure. E = market value of equity, D = market value of debt, V = E + D, Re = cost of equity (via CAPM), Rd = cost of debt, T = corporate tax rate. WACC is the discount rate for FCFF. A WACC of 10% means the company must generate returns above 10% to create value.' },
          { type: 'text', content: 'The <strong>Terminal Value</strong> typically represents 60-80% of total DCF value. Two methods: (1) <strong>Gordon Growth Model</strong>: TV = FCF(t+1) / (WACC - g), where g is the perpetual growth rate (typically 2-3%, aligned with long-run GDP). (2) <strong>Exit Multiple</strong>: apply an EV/EBITDA multiple to year-N EBITDA. A 0.5% change in the terminal growth rate can change equity value by 20-30%, which is why sensitivity analysis is mandatory in professional work.' },
          { type: 'callout', style: 'info', title: 'DCF in Practice: The Art of Assumptions', content: 'Revenue growth, EBIT margin expansion, capex intensity, working capital requirements, and the terminal assumption each introduce model risk. A 5-year DCF with aggressive assumptions can justify almost any price — this is why activist short sellers publish "forensic DCF" analyses showing how sell-side target prices require unsustainable growth rates. The discipline lies in benchmarking every assumption against historical performance and comparable companies.' }
        ]
      },
      {
        id: 'sec-relative-valuation',
        title: 'Relative Valuation: Multiples and Comparables',
        blocks: [
          { type: 'heading', level: 2, content: 'Trading Multiples, Transaction Multiples, and Precedent Analysis' },
          { type: 'text', content: 'In practice, most deals and investment decisions are validated using relative valuation — comparing a company\'s multiples to peers. The two primary frameworks are <strong>Trading Comparables</strong> (public market multiples of similar companies today) and <strong>Precedent Transactions</strong> (multiples paid in historical M&A deals for similar companies, usually with a control premium).' },
          { type: 'keyterm', term: 'EV/EBITDA', definition: 'Enterprise Value divided by EBITDA. The most widely used acquisition valuation multiple because it is capital structure neutral and not affected by depreciation accounting policy. Typical ranges by sector: software (15-30x), industrial (8-12x), retail (6-10x), telecom (7-9x), pharma (10-15x). Paying 12x for a software company growing 40%/year may be cheap; paying 12x for a declining retail chain may be expensive.' },
          { type: 'keyterm', term: 'P/E Ratio', definition: 'Price per share divided by Earnings per share (EPS). The most commonly cited equity valuation metric. However, P/E is distorted by leverage, one-time items, and accounting differences. Analysts prefer to use P/E on "normalised" or "core" earnings. Forward P/E (based on next twelve months estimates) is more useful than trailing P/E for valuing growth companies.' },
          { type: 'text', content: 'The <strong>PEG ratio</strong> (Price/Earnings / Earnings Growth Rate) attempts to normalise P/E for growth. A P/E of 30x for a company growing earnings at 30%/year gives a PEG of 1.0x — typically considered fair value. PEG below 1.0x indicates potential undervaluation relative to growth. Peter Lynch popularised PEG as a retail investor screening tool. Professional analysts use it as a first-pass screen, not a standalone valuation.' },
          { type: 'callout', style: 'warning', title: 'The Garbage-In Problem', content: 'Comparable company analysis is only as good as the comp set selection. Choosing comps with structurally different margins, growth profiles, or capital requirements will produce misleading ranges. Banks were routinely accused of cherry-picking comps in fairness opinions during the 2007-08 M&A boom to justify acquisition premiums that were ultimately value-destructive. Always verify: are the selected comps genuinely comparable on business model, geography, margin profile, and capital intensity?' }
        ]
      },
      {
        id: 'sec-fixed-income-pro',
        title: 'Bond Pricing, Duration and the Yield Curve',
        blocks: [
          { type: 'heading', level: 2, content: 'The Mechanics of Fixed Income Valuation' },
  ...
  'lesson-ecfl-f3-derivatives': {
    sections: [
      {
        id: 'sec-futures-pricing',
        title: 'Futures Pricing and the Cost of Carry',
        blocks: [
          { type: 'heading', level: 2, content: 'The Theoretical Foundation of Forward Prices' },
          { type: 'text', content: 'A futures contract obligates the buyer to purchase (and the seller to deliver) an underlying asset at a specified price on a future date. The <strong>fair value</strong> of a futures price is derived from the cost of carry model: the spot price plus the net cost of holding the asset until delivery.' },
          { type: 'keyterm', term: 'Cost of Carry Formula', definition: 'F = S x e^(r-q)T (continuous compounding), where F = futures price, S = spot price, r = risk-free rate, q = continuous yield (dividends for equities, storage cost adjusted convenience yield for commodities), T = time to expiry in years. This relationship is enforced by arbitrage — if the futures price deviates significantly, dealers lock in risk-free profits by buying/selling the spot asset and the opposite futures position.' },
          { type: 'text', content: '<strong>Backwardation and Contango</strong>: <strong>Contango</strong>: futures price > spot price (most common for non-yielding assets with positive carry costs). <strong>Backwardation</strong>: futures price < spot price (occurs when the convenience yield of holding the physical commodity exceeds carry costs — common in energy during supply shocks). In 2020, WTI crude futures briefly traded at <strong>negative prices</strong> (-$37/barrel) as storage capacity ran out and holders of expiring contracts faced massive physical delivery costs.' },
          { type: 'text', content: 'In crypto markets, the analogous concept is the <strong>perpetual futures funding rate</strong>. Perpetual contracts have no expiry; instead, longs pay shorts (or vice versa) a periodic funding rate to keep the perpetual price anchored to spot. When the funding rate is positive and elevated (longs paying >0.1%/8h), it signals overleveraged speculative longs — historically a warning sign of impending liquidation cascades.' }
        ]
      },
      {
        id: 'sec-black-scholes',
        title: 'Black-Scholes Option Pricing',
        blocks: [
          { type: 'heading', level: 2, content: 'The Formula That Changed Finance' },
          { type: 'text', content: 'The Black-Scholes-Merton model (1973) was the first closed-form solution for pricing European options. Fischer Black, Myron Scholes, and Robert Merton shared the 1997 Nobel Prize in Economics for this work. The formula assumes: no dividends, constant volatility, no transaction costs, continuous trading, log-normal asset returns, and a known constant risk-free rate.' },
          { type: 'keyterm', term: 'Black-Scholes Formula', definition: 'For a European call: C = S.N(d1) - K.e^(-rT).N(d2). For a European put: P = K.e^(-rT).N(-d2) - S.N(-d1). Where: d1 = [ln(S/K) + (r + v^2/2)T] / (v.sqrt(T)); d2 = d1 - v.sqrt(T). S = spot price, K = strike price, r = risk-free rate, T = time to expiry, v = implied volatility, N() = standard normal CDF.' },
          { type: 'text', content: '<strong>Worked example (BTC call option):</strong> BTC spot = $60,000. Strike K = $65,000 (OTM). Time T = 30 days (0.0822 years). Risk-free rate r = 5%. Implied vol v = 80%. d1 = [ln(60000/65000) + (0.05 + 0.32) x 0.0822] / (0.80 x 0.2867) = [-0.0800 + 0.0304] / 0.2294 = -0.2165. d2 = -0.2165 - 0.2294 = -0.4459. N(d1) = 0.4143, N(d2) = 0.3278. C = 60000 x 0.4143 - 65000 x 0.9959 x 0.3278 = 24,858 - 21,206 = <strong>$3,652</strong>.' },
          { type: 'text', content: 'The <strong>implied volatility smile/skew</strong> is the most important departure from Black-Scholes. If the model were perfectly correct, implied vol would be constant across all strikes. In reality it varies — forming a "smile" in equity index options (higher IV for deep ITM and OTM). The equity put skew exists because portfolio managers pay a premium for downside protection. The crypto smile is more symmetric because traders fear both upside and downside tail events.' }
        ]
      },
      {
        id: 'sec-greeks-advanced',
        title: 'The Greeks: Full Analytical Framework',
        blocks: [
          { type: 'heading', level: 2, content: 'Managing Options Risk Quantitatively' },
          { type: 'text', content: 'The Greeks quantify an option\'s sensitivity to changes in its pricing inputs. Professional options traders manage portfolios by targeting specific Greek exposures. Market makers continuously delta-hedge to remain directionally neutral, monetising the bid-ask spread and volatility risk premium.' },
          { type: 'keyterm', term: 'Delta', definition: 'Rate of change of option price per $1 change in underlying price. Call delta ranges 0 to +1; put delta -1 to 0. An ATM option has delta approx 0.50. Delta also approximates the probability the option expires in the money. Delta-neutral hedging requires continuous adjustment as the spot moves and time passes.' },
          { type: 'keyterm', term: 'Gamma', definition: 'Rate of change of delta per $1 change in the underlying. Peaks for ATM options near expiry. Long gamma means your delta increases as the stock rallies and decreases as it falls — you are "long convexity." Short gamma (sold options): as the stock moves, your position becomes increasingly directionally wrong. Gamma risk is the main risk market makers manage via dynamic delta hedging.' },
          { type: 'keyterm', term: 'Vega', definition: 'Sensitivity of the option price to a 1% change in implied volatility. Long options (long vega) benefit from rising volatility; short options (short vega) profit from falling vol. Vega peaks for ATM options with longer expiry. Vol traders buy options when IV is low relative to expected realised vol, sell when IV is high.' },
          { type: 'keyterm', term: 'Theta', definition: 'Time decay: the daily erosion in an option\'s value as time passes, all else equal. Negative for long options (you lose value daily), positive for short options (you collect decay). ATM options near expiry have the highest theta. The conflict between gamma and theta is central: long gamma (beneficial convexity) costs you theta (daily decay). Short-dated ATM options maximise this trade-off.' }
        ]
      },
      {
        id: 'sec-swaps-credit-derivatives',
        title: 'Swaps and Credit Derivatives',
        blocks: [
          { type: 'heading', level: 2, content: 'The OTC Derivatives Market: $600 Trillion in Notional Value' },
          { type: 'text', content: 'Over-the-counter derivatives markets dwarf exchange-traded markets. The notional value of outstanding OTC derivatives reached approximately <strong>$600 trillion</strong> (BIS, 2023). Interest rate swaps account for ~70% of this market; credit derivatives ~5%; FX derivatives ~16%.' },
          { type: 'keyterm', term: 'Interest Rate Swap (IRS)', definition: 'An agreement between two parties to exchange fixed interest rate payments for floating rate payments (typically SOFR or EURIBOR) on a specified notional principal. The notional is never exchanged — only the net interest difference changes hands. Companies use swaps to convert floating-rate debt to fixed, or to speculate on rate directions. Most common: 5-year "plain vanilla" swap — Party A pays fixed (the "swap rate"), Party B pays SOFR + spread.' },
          { type: 'keyterm', term: 'Credit Default Swap (CDS)', definition: 'A credit derivative functioning as insurance against a reference entity defaulting on its debt. The protection buyer pays a periodic premium (CDS spread, in basis points p.a.). In a credit event (default, restructuring, bankruptcy), the protection seller pays face value in exchange for the defaulted bond. CDS allow investors to go "short credit" without selling the underlying bond.' },
          { type: 'text', content: 'The <strong>CDS market played a central role in the 2008 financial crisis</strong>. AIG had sold CDS protection on $440 billion of mortgage-related CDOs. When housing collapsed, AIG faced collateral calls it could not meet — triggering a systemic liquidity crisis requiring a $185 billion government bailout. Post-crisis reforms (Dodd-Frank in the US, EMIR in the EU) require most standardised derivatives to be cleared through central counterparties (CCPs).' },
          { type: 'callout', style: 'warning', title: 'EMIR and Clearing Mandates', content: 'European Market Infrastructure Regulation (EMIR) requires financial counterparties to centrally clear standardised OTC derivatives through authorised CCPs. Cleared trades require daily variation margin, initial margin, and default fund contributions. The London Clearing House (LCH) clears approximately $360 trillion in notional annually. CCP default would be a systemic event — hence ongoing debates about "too big to fail" CCPs.' }
        ]
      }
    ]
  },
...
,
  ...
  'lesson-ecfl-f2-equity': {
    sections: [
      ...
      },
      {
        ...
        blocks: [
          { type: 'heading', level: 2, content: 'DuPont Analysis: Decomposing ROE' },
          ...
          { type: 'heading', level: 3, content: 'The Three-Factor DuPont Framework' },
          { type: 'text', content: 'The three-factor DuPont model breaks ROE into three multiplicative components: profit margin (profitability), asset turnover (efficiency), and financial leverage.' },
          { type: 'keyterm', term: 'Three-Factor DuPont', definition: 'ROE = Net Profit Margin × Asset Turnover × Equity Multiplier, where: Net Profit Margin = Net Income / Revenue (profitability), Asset Turnover = Revenue / Average Total Assets (efficiency), Equity Multiplier = Average Total Assets / Average Equity (leverage). Verify: (Net Income/Revenue) × (Revenue/Assets) × (Assets/Equity) = Net Income/Equity = ROE. Example: Company A — Net Margin 8%, Asset Turnover 1.5x, Equity Multiplier 2.0x → ROE = 8% × 1.5 × 2.0 = 24%.' },
          { type: 'heading', level: 3, content: 'Five-Factor DuPont: The Full Decomposition' },
          { type: 'keyterm', term: 'Five-Factor DuPont', definition: 'ROE = Tax Burden × Interest Burden × EBIT Margin × Asset Turnover × Equity Multiplier, where: Tax Burden = Net Income / EBT (how much after-tax income is retained per unit of pre-tax income), Interest Burden = EBT / EBIT (how much pre-tax income remains after interest), EBIT Margin = EBIT / Revenue (operating profitability). This separates the effects of tax efficiency, financial leverage costs, and operating performance. Example: ROE = 0.78 × 0.85 × 0.18 × 1.2 × 2.5 = 0.78×0.85 = 0.663; ×0.18 = 0.119; ×1.2 = 0.143; ×2.5 = 35.8%.' },
          { type: 'heading', level: 3, content: 'Worked Example: Apple vs Tesla (FY2023)' },
          { type: 'text', content: 'Let us apply the five-factor DuPont to Apple and Tesla using their FY2023 financial data. This reveals starkly different routes to similar headline ROE numbers.' },
          { type: 'text', content: '<strong>Apple FY2023:</strong> Revenue $383.3bn, EBIT $114.3bn, EBT $113.7bn, Net Income $97.0bn, Average Total Assets $335bn, Average Equity $62bn. Calculations: Tax Burden = 97.0/113.7 = 0.854 (effective tax rate 14.6%); Interest Burden = 113.7/114.3 = 0.995 (almost no net interest burden — Apple earns more on its cash than it pays on debt); EBIT Margin = 114.3/383.3 = 29.8%; Asset Turnover = 383.3/335 = 1.14x; Equity Multiplier = 335/62 = 5.40x. ROE = 0.854 × 0.995 × 0.298 × 1.14 × 5.40 = <strong>156.4%</strong>. This extraordinary ROE is driven primarily by the massive equity multiplier (Apple\'s aggressive share buybacks have reduced reported equity to minimal levels) combined with genuinely excellent margins.' },
          { type: 'text', content: '<strong>Tesla FY2023:</strong> Revenue $97.7bn, EBIT $8.9bn, EBT $9.97bn (Tesla actually earned more pre-tax than its EBIT due to interest income on its cash pile), Net Income $15.0bn (including deferred tax benefit), Average Total Assets $92bn, Average Equity $38bn. Adjusted for the tax benefit: Normalised Net Income ≈ $9.5bn. Tax Burden = 0.95; Interest Burden = 1.12 (interest income exceeds interest expense); EBIT Margin = 9.1%; Asset Turnover = 97.7/92 = 1.06x; Equity Multiplier = 92/38 = 2.42x. Normalised ROE = 0.95 × 1.12 × 0.091 × 1.06 × 2.42 = <strong>24.8%</strong>.' },
          { type: 'text', content: 'The contrast is instructive: Apple\'s superior ROE is driven by incomparable brand/ecosystem margins (29.8% EBIT margin vs Tesla\'s 9.1%) and highly leveraged equity base (multiplier 5.4x vs 2.4x). Tesla generates respectable returns from a much younger capital base with lower margins — appropriate for a company still scaling manufacturing. Apple\'s equity multiplier would be alarming in any other context, but its enormous free cash flow and AAA-equivalent credit quality make it sustainable.' },
          { type: 'callout', style: 'tip', title: 'DuPont as a Diagnostic Tool', content: 'Use DuPont analysis not just to understand where ROE comes from, but to forecast where it will go. If a company\'s ROE improvement is coming entirely from rising leverage (expanding equity multiplier) while margins and asset turnover are stagnant or declining, the quality of that ROE improvement is poor. The most durable ROE improvements come from margin expansion or genuine asset efficiency gains.' },
          { type: 'activity', style: 'multiplechoice', title: 'DuPont Analysis Application', instructions: 'Apply DuPont concepts to the following scenarios.', items: [
            { question: 'A company has Net Margin 5%, Asset Turnover 2.0x, Equity Multiplier 3.0x. What is its ROE?', options: ['10%', '30%', '15%', '6%'], answer: 1 },
            { question: 'Company X and Company Y both report ROE of 18%. X has Equity Multiplier of 1.2x; Y has Equity Multiplier of 4.5x. Which has higher quality ROE, assuming similar margins?', options: ['Company Y, because higher leverage amplifies returns', 'Company X, because its returns are driven by operational performance not leverage', 'They are equal quality — ROE is the same', 'Cannot determine without revenue data'], answer: 1 },
            { question: 'In the five-factor DuPont, the "Interest Burden" ratio (EBT/EBIT) will be less than 1.0 when:', options: ['The company has no debt', 'The company pays net interest expense (interest expense exceeds interest income)', 'The company\'s effective tax rate is very high', 'Asset turnover is below 1.0x'], answer: 1 },
            { question: 'Apple\'s very high Equity Multiplier (>5x) is primarily a result of:', options: ['Taking on excessive debt to fund acquisitions', 'Decades of aggressive share buybacks reducing reported equity', 'Unusually high intangible assets on the balance sheet', 'Thin profit margins requiring high leverage to achieve target ROE'], answer: 1 }
          ]}
        ]
      },
      {
        id: 'sec-f2eq-earningsquality',
        title: 'Earnings Quality & Manipulation Detection',
        blocks: [
          { type: 'heading', level: 2, content: 'Earnings Quality & Manipulation Detection' },
          { type: 'text', content: 'Reported earnings are not always what they seem. Accounting standards give management significant discretion over revenue recognition, expense classification, and asset valuation — discretion that can be used conservatively or exploited aggressively. <strong>Earnings quality analysis</strong> is the discipline of determining whether reported profits are genuine, sustainable, and cash-backed, or whether they are being manufactured through accounting manipulation.' },
          { type: 'heading', level: 3, content: 'The Accruals Ratio' },
          { type: 'keyterm', term: 'Accruals Ratio', definition: 'Accruals Ratio = (Net Income − Operating Cash Flow) / Average Net Operating Assets, where Net Operating Assets = (Total Assets − Cash) − (Total Liabilities − Total Debt). Measures the proportion of earnings that are accruals (non-cash) rather than hard cash. Research by Sloan (1996) found that high-accruals companies significantly underperform low-accruals companies in the following year, suggesting markets are slow to price earnings quality. Example: a company reports Net Income $100m but Operating Cash Flow of only $40m. Accruals = $60m. If average NOA = $500m, Accruals Ratio = 60/500 = 12% — a high and concerning reading.' },
          { type: 'text', content: 'The principle behind the accruals ratio is straightforward: cash is harder to manipulate than accrual-based earnings. A company earning $100m and generating $100m of operating cash flow has high earnings quality. A company earning $100m but generating only $20m of cash flow has significant non-cash accruals — these might be legitimate (rapid receivables growth from genuine revenue acceleration) or manipulative (premature revenue recognition, capitalised expenses).' },
          { type: 'heading', level: 3, content: 'The Beneish M-Score' },
          { type: 'text', content: 'Professor Messod Beneish developed the <strong>M-Score</strong> in 1999 as a quantitative model for detecting earnings manipulation. It uses eight financial ratios to generate a single score — the higher the score, the greater the likelihood of manipulation.' },
          { type: 'keyterm', term: 'Beneish M-Score', definition: 'M = −4.84 + 0.92(DSRI) + 0.528(GMI) + 0.404(AQI) + 0.892(SGI) + 0.115(DEPI) − 0.172(SGAI) + 4.679(TATA) − 0.327(LVGI), where: DSRI = Days Sales Receivable Index (receivables growth vs revenue growth — high score suggests revenue stuffing), GMI = Gross Margin Index (deteriorating margins incentivise manipulation), AQI = Asset Quality Index (rising non-current, non-physical assets), SGI = Sales Growth Index (high growth companies more likely to manipulate), DEPI = Depreciation Index (slowing depreciation inflates assets), SGAI = SG&A Index, TATA = Total Accruals to Total Assets, LVGI = Leverage Index. Threshold: M > −1.78 suggests possible manipulation; M > −1.49 is a strong signal. Example: Enron pre-bankruptcy M-Score was approximately −0.94, far above the manipulation threshold.' },
          { type: 'heading', level: 3, content: 'Red Flags in Revenue Recognition' },
          { type: 'text', content: 'Under IFRS 15 and US GAAP ASC 606, revenue is recognised when (or as) a performance obligation is satisfied — when control of goods or services transfers to the customer. Manipulation typically occurs by recognising revenue too early (before the obligation is satisfied) or for transactions that lack economic substance.' },
          { type: 'text', content: '<strong>Channel stuffing</strong> occurs when a company ships excess product to distributors at quarter-end to inflate revenue, knowing much will be returned. The tell-tale sign is a Day Sales Outstanding (DSO) ratio that spikes at reporting dates: DSO = (Accounts Receivable / Revenue) × 365. If DSO jumps from 45 days to 75 days in a single quarter with no corresponding explanation, investigate.' },
          { type: 'text', content: '<strong>Bill-and-hold arrangements</strong> allow a customer to purchase goods but have delivery occur later — legitimate if the customer has genuine business reasons for not taking possession, but abused to pull forward revenue recognition. Under IFRS 15, bill-and-hold revenue is permissible only if six specific criteria are met, including that the goods are separately identified and ready for delivery.' },
          { type: 'heading', level: 3, content: 'Case Study: Wirecard — The €1.9 Billion Hole' },
          { type: 'text', content: '<strong>Wirecard AG</strong>, a German fintech company that was included in the DAX 30 index, collapsed in June 2020 after its auditor (Ernst & Young) could not verify that €1.9bn of cash supposedly held in trust accounts in the Philippines actually existed. The money turned out to be fictitious — an elaborate fraud spanning years.' },
          { type: 'text', content: 'What made Wirecard compelling to many analysts was its apparently excellent growth story: revenue growing 30%+ annually, EBITDA margins above 30%, and an exciting fintech narrative. But several red flags were present for those who looked carefully. The company\'s <strong>Days Sales Outstanding</strong> was unusually high and volatile. Its reported profits persistently outpaced its cash conversion. Its geographic revenue mix — particularly the portion attributed to opaque "third-party acquiring" partners in Asia — was disproportionately large and impossible to independently verify.' },
          { type: 'text', content: 'The Financial Times\'s investigative journalists Olaf Storbeck and Dan McCrum repeatedly raised these concerns from 2015 onwards. Wirecard repeatedly denied the allegations, filed criminal complaints against the journalists, and attracted the support of German financial regulators who initially investigated the journalists rather than the company. This case illustrates that financial fraud can persist for years when institutional trust is misplaced and critical analysis is suppressed.' },
          { type: 'callout', style: 'warning', title: 'Earnings Quality Checklist', content: 'Before trusting reported earnings, verify: (1) Is operating cash flow tracking net income? If OCF/Net Income < 0.7 consistently, investigate. (2) Are receivables growing faster than revenue? (3) Are inventories growing faster than COGS? (4) Has the company changed accounting policies (revenue recognition, depreciation method) without clear justification? (5) Is there auditor rotation without explanation? (6) Are there large "other receivables" or assets held with obscure third parties? (7) Does management guidance have a track record of consistent overstatement?' },
          { type: 'text', content: 'Additional manipulation patterns include: <strong>big bath accounting</strong> (taking massive write-downs in a single bad year to clear the decks and make future earnings look better), <strong>cookie jar reserves</strong> (creating excess provisions in good years and releasing them in bad years to smooth earnings), and <strong>capitalisation of operating expenses</strong> (treating normal operating costs as capital expenditure to shift them to the balance sheet and inflate current earnings).' }
        ]
      },
      {
        id: 'sec-f2eq-sectoranalysis',
        title: 'Sector Analysis Frameworks',
        blocks: [
          { type: 'heading', level: 2, content: 'Sector Analysis Frameworks' },
          { type: 'text', content: 'Equity analysis is not sector-agnostic. The metrics that matter for a technology platform company are fundamentally different from those relevant to a bank, an airline, or a pharmaceutical company. Using generic frameworks without adaptation leads to category errors — for instance, applying standard P/E ratios to a loss-making biotech or Net Debt/EBITDA to a bank.' },
          { type: 'heading', level: 3, content: 'Financial Institutions: Banks & Insurers' },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'activity', style: 'multiplechoice', title: 'Valuation Multiples Practice', instructions: 'Apply valuation frameworks to the following scenarios.', items: [
            { question: 'A company trades at 22x forward P/E with expected EPS growth of 11% annually. Its PEG ratio is approximately:', options: ['0.5x', '2.0x', '1.5x', '11x'], answer: 1 },
            { question: 'EV/EBITDA is preferred over P/E for comparing companies with different capital structures because:', options: ['EBITDA is always larger than net income, making the ratio more conservative', 'EV captures total firm value and EBITDA is pre-interest, making it capital structure neutral', 'P/E is only valid for companies with positive earnings', 'EBITDA includes depreciation which smooths cyclical earnings'], answer: 1 },
            { question: 'Benjamin Graham\'s "Net-Net" strategy involves purchasing stocks below:', options: ['Book value per share', 'Net Current Asset Value divided by shares outstanding', 'Five times trailing earnings per share', 'Enterprise value equals EBITDA'], answer: 1 },
            { question: 'A stock with Forward P/E of 8x and expected EPS growth of 15% has a PEG of approximately 0.53x. This suggests the stock is:', options: ['Overvalued relative to its growth rate', 'Potentially undervalued relative to its growth rate', 'Fairly valued at exactly 1.0x PEG', 'A high-quality growth company regardless of price'], answer: 1 }
          ]}
        ]
      },
      {
        id: 'sec-f2eq-screening',
        title: 'Equity Screening: Building a Stock Screen',
        blocks: [
          { type: 'heading', level: 2, content: 'Equity Screening: Building a Stock Screen' },
          ...
          { type: 'callout', style: 'warning', title: 'Survivorship Bias in Backtests', content: 'Most financial databases only contain companies that still exist today. This creates survivorship bias — failed companies are excluded from the historical universe, making every strategy look better historically than it would have performed in real time. Academic-quality backtests use point-in-time databases (e.g., Compustat\'s historical snapshots) that include all companies that existed at each point, including those that later went bankrupt or were delisted.' }
        ]
      },
      {
        id: 'sec-f2eq-moatanalysis',
        title: 'Competitive Advantage & Moat Analysis',
        blocks: [
          { type: 'heading', level: 2, content: 'Competitive Advantage & Moat Analysis' },
          { type: 'text', content: 'Warren Buffett popularised the concept of the economic "moat" — a durable competitive advantage that protects a company\'s above-normal profits from competitive erosion. The key word is <em>durable</em>: any company can earn excess returns temporarily through innovation, timing, or luck. A moat company sustains those excess returns over a decade or more because competitors face structural barriers to imitation.' },
          { type: 'heading', level: 3, content: 'Porter\'s Five Forces Applied to Stock Analysis' },
          { type: 'text', content: 'Michael Porter\'s Five Forces framework identifies the competitive dynamics that determine industry profitability. Applied to equity analysis, it helps analysts assess whether a company\'s current margins are sustainable or will be competed away.' },
          { type: 'text', content: '<strong>Threat of New Entrants:</strong> High barriers to entry (regulation, capital requirements, network effects, brand recognition) protect incumbents. Example: Banking — new entrants face capital requirements, regulatory licensing, the need to build trust, and competition from entrenched players with massive cost advantages from scale. The UK\'s fintech challengers (Monzo, Revolut) have disrupted retail banking\'s user interface but struggle to threaten the core lending profitability of incumbents because they cannot cheaply fund loan books.' },
          { type: 'text', content: '<strong>Bargaining Power of Suppliers:</strong> When suppliers have few alternatives (e.g., TSMC as the only manufacturer capable of advanced chip fabrication for Apple, NVIDIA, Qualcomm), they capture a portion of value. TSMC\'s pricing power has been exceptional — it consistently raises prices while maintaining its monopoly on the most advanced nodes.' },
          { type: 'text', content: '<strong>Bargaining Power of Buyers:</strong> When customers are large and concentrated, they extract value. Walmart negotiating with consumer goods suppliers is the classic example — Walmart represents 25-30% of P&G\'s global revenue, giving it exceptional pricing leverage. P&G\'s response has been building brand loyalty so strong that Walmart cannot afford to de-list their products.' },
          { type: 'text', content: '<strong>Threat of Substitutes:</strong> Substitutes price-cap the industry. Taxi services were substitute-constrained not by other taxi companies but by public transport, cycling, and walking — until Uber/Lyft introduced an entirely different substitute model.' },
          { type: 'text', content: '<strong>Competitive Rivalry:</strong> Industries with many undifferentiated competitors competing primarily on price have structurally low margins. The airline industry is the canonical example: high fixed costs, commodity product, price-sensitive customers, and excess capacity during downturns combine to make sustained profitability extremely difficult. Southwest Airlines was one of the few to build a genuine cost moat within this brutal structure.' },
          { type: 'heading', level: 3, content: 'Sources of Economic Moat' },
          { type: 'text', content: '<strong>Network Effects:</strong> The product becomes more valuable as more users join (Visa/Mastercard payment networks, Meta\'s social graph, MSCI indices used as benchmarks). Visa\'s moat deepens with every new merchant and cardholder — a challenger must convince both simultaneously, creating a classic chicken-and-egg barrier.' },
          { type: 'text', content: '<strong>Switching Costs:</strong> When customers face significant costs (financial, operational, psychological) to switch providers, they tend to stay even when alternatives exist. Enterprise software (SAP, Oracle) creates switching costs through deep integration with business processes, extensive user training, and years of data locked in proprietary formats — switching ERP systems typically costs companies millions and years of disruption.' },
          { type: 'text', content: '<strong>Cost Advantages:</strong> Scale (Amazon logistics), proprietary processes (Nucor\'s EAF steelmaking efficiency), favourable access to resources (a copper miner sitting on one of the world\'s highest-grade deposits). Costco\'s membership model creates a cost advantage: its gross margins are structurally lower than competitors because it prices for member value, but membership fees (which are nearly 100% profit) compensate and create member loyalty through perceived value.' },
          { type: 'text', content: '<strong>Intangible Assets:</strong> Brand (LVMH\'s Louis Vuitton, Ferrari), patents (pharmaceutical companies\' drug exclusivity windows), regulatory licenses (broadcast spectrum, pharmaceutical marketing authorisations, financial services licences). LVMH\'s Louis Vuitton brand generates gross margins above 65% on leather goods with essentially no advertising spend compared to competitors — the brand IS the moat.' },
          { type: 'keyterm', term: 'Moat Width and Depth', definition: 'Width refers to the number of markets where the moat applies; depth refers to how strong the protection is within each market. A narrow-but-deep moat (e.g., a small specialty chemical producer with a patent-protected formulation in one market) may be highly valuable if that market is attractive. A wide-but-shallow moat (e.g., a bank with name recognition but no structural cost advantage) may be less sustainable. The best businesses have both: Visa has wide (global payments) and deep (two-sided network effects) moats simultaneously.' }
        ]
      },
      {
        id: 'sec-f2eq-management',
        title: 'Management Quality Assessment',
        blocks: [
          { type: 'heading', level: 2, content: 'Management Quality Assessment' },
          { type: 'text', content: 'Numbers reflect the past; management determines the future. Assessing the quality of corporate leadership is one of the most important and most subjective aspects of fundamental equity analysis. Unlike financial ratios, management quality cannot be precisely quantified — but it can be systematically evaluated through observable evidence.' },
          { type: 'heading', level: 3, content: 'Capital Allocation Track Record' },
          { type: 'text', content: 'The most objective measure of management quality is the <strong>long-term capital allocation track record</strong>. Managers have five uses of capital: reinvestment in the business (organic growth), M&A, dividends, share buybacks, and balance sheet strengthening (debt repayment). Excellent capital allocators deploy capital at the highest available risk-adjusted return — consistently.' },
          { type: 'text', content: 'Warren Buffett\'s test: over 10 years, has every dollar retained in the business (rather than paid as dividends) created more than one dollar of market value? Many management teams destroy value by retaining earnings and reinvesting them at returns below their cost of capital — funding marginal acquisitions, building empires, or defending declining businesses. The value-destroying cycle can persist for years before shareholders demand change.' },
          { type: 'text', content: 'Evaluate M&A through the lens of value creation: what did the company pay (EV/EBITDA multiple), what synergies were promised, and what was actually delivered? Research consistently shows that 70%+ of acquisitions destroy value for the acquiring company\'s shareholders within 3 years. Management teams that acknowledge mistakes and course-correct are far more valuable than those who double down on failed strategies.' },
          { type: 'heading', level: 3, content: 'Insider Ownership & Alignment' },
          { type: 'text', content: 'Management teams with significant personal wealth at stake in the company they run have stronger incentives to create long-term value. <strong>Insider ownership</strong> (shares held by executives and board members as a percentage of outstanding shares) is a useful alignment proxy. High insider ownership reduces principal-agent problems — the manager and the shareholder share the same economic interest.' },
          ...
          { type: 'heading', level: 3, content: 'Compensation Structure & Red Flags' },
          { type: 'text', content: 'Examine compensation structure carefully. Well-designed compensation links pay to genuine long-term value creation: ROIC targets, multi-year EPS growth, relative TSR against appropriate peers. Red flags include: <strong>peer group cherry-picking</strong> (selecting underperforming peers to make relative metrics look better), <strong>excessive base salary</strong> not linked to performance, <strong>discretionary bonuses</strong> that get paid even when targets are missed, and <strong>option repricing</strong> (resetting option strike prices downward when the stock falls — heads I win, tails I get bailed out).' },
          { type: 'callout', style: 'tip', title: 'Reading Proxy Statements', content: 'Management compensation details are in the annual proxy statement (DEF 14A for US companies, Remuneration Report section of the Annual Report for UK/European companies). Read the performance targets in full — not the CEO pay figure in isolation. A CEO earning $50m might be entirely justified if they hit stretch targets creating $5bn of shareholder value. A CEO earning $10m with targets set below last year\'s actual performance is extracting value, not creating it.' },
          { type: 'heading', level: 3, content: 'Assessing Management Communication' },
          { type: 'text', content: 'High-quality management teams communicate with clarity, intellectual honesty, and consistent messaging. They do not change the key performance metrics they report from year to year. They acknowledge mistakes and explain how they are being corrected. They give guidance that is achievable rather than promotional. When they miss guidance, they explain why clearly — not with excuses that blame external factors while taking credit for all successes.' },
          { type: 'text', content: 'Amazon\'s annual letters (written by Jeff Bezos from 1997-2020) are widely studied as a masterclass in clear strategic thinking and honest communication. Each letter was prefaced by the original 1997 letter setting out the investment philosophy — an unusual commitment to consistency that allowed investors to track over 23 years whether management was executing against a stated strategy. This kind of radical transparency is the gold standard.' }
        ]
      },
      {
        id: 'sec-f2eq-corporateevents',
        title: 'Corporate Events: M&A, Spinoffs & Buybacks',
        blocks: [
          { type: 'heading', level: 2, content: 'Corporate Events: M&A, Spinoffs & Buybacks' },
          { type: 'text', content: 'Corporate events — mergers, acquisitions, divestitures, spinoffs, and capital returns — are among the most significant drivers of short-term equity price movements and long-term value creation or destruction. Event-driven analysis is a specialised discipline within equity analysis.' },
          { type: 'heading', level: 3, content: 'M&A: Acquirer vs Target Dynamics' },
          { type: 'text', content: 'When an acquisition is announced, the target\'s stock typically rallies toward the offer price (less a deal uncertainty discount), while the acquirer\'s stock often falls. The acquirer\'s decline reflects market scepticism about the price paid, synergy assumptions, and integration risk. The magnitude of the acquirer\'s decline is a real-time market verdict on deal quality.' },
          { type: 'text', content: 'MSFT\'s $68.7bn acquisition of Activision Blizzard (announced January 2022, closed October 2023) provides a useful case study. MSFT\'s stock fell ~2.5% on announcement — a relatively benign market reaction reflecting confidence in Microsoft\'s capital allocation track record and the strategic logic (gaming content for Xbox Game Pass). The deal ultimately closed at $95 per share vs a pre-announcement price of ~$65, representing a 46% premium to undisturbed price.' },
          { type: 'heading', level: 3, content: 'Spinoffs: Unlocking Hidden Value' },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'keyterm', term: 'LTM vs NTM Multiples', definition: 'LTM (Last Twelve Months) uses trailing historical financials — more factual but less relevant for forward-looking valuation. NTM (Next Twelve Months) uses consensus forecast financials — more relevant for valuation but depends on forecast accuracy. Growth companies trade at lower NTM multiples than LTM multiples (because future earnings are higher), and declining companies show the opposite. Always specify whether a multiple is LTM or NTM when communicating analysis. Example: a company earning $100m LTM and expected to earn $130m NTM at a $1.3bn market cap trades at 13x LTM P/E or 10x NTM P/E — a significant difference in apparent valuation.' },
          { type: 'activity', style: 'multiplechoice', title: 'Valuation Methods Review', instructions: 'Test your understanding of relative valuation concepts.', items: [
            { question: 'Why is peer group selection critical in comparable company analysis?', options: ['The peer group determines which country\'s accounting standards to use', 'Using dissimilar companies produces meaningless multiples that may mislead rather than inform', 'SEC regulations require specific peer groups for valuation', 'Peer group selection determines which auditor must sign off on the valuation'], answer: 1 },
            { question: 'A company has LTM EBITDA of £50m and NTM EBITDA of £70m. Its EV is £700m. What is its NTM EV/EBITDA?', options: ['14.0x', '10.0x', '7.0x', '5.0x'], answer: 1 },
            { question: 'A football field chart in investment banking valuation is used to:', options: ['Determine which sports teams to exclude from ESG screens', 'Present valuation ranges from multiple methodologies on a single visual to identify zones of consensus', 'Show the seasonal revenue pattern of a consumer company', 'Illustrate the capital structure waterfall in bankruptcy'], answer: 1 },
            { question: 'If a target company trades at a 40% discount to peer group median EV/EBITDA, the analyst should first:', options: ['Immediately recommend buying the stock as it is undervalued', 'Investigate whether the discount is justified by inferior growth, margins, or higher risk profile', 'Apply the peer median multiple to estimate target price without further analysis', 'Check whether the company\'s EBITDA is calculated on the same basis as peers'], answer: 3 }
          ]}
        ]
      }
    ]
  ...
  'lesson-ecfl-f2-fixedincome': {
    sections: [
      {
        id: 'sec-f2fi-bondmath',
        title: 'Bond Mathematics: Price, Yield & Reinvestment',
        blocks: [
          { type: 'heading', level: 2, content: 'Bond Mathematics: Price, Yield & Reinvestment' },
          ...
          { type: 'heading', level: 3, content: 'The Bond Pricing Formula' },
          { type: 'keyterm', term: 'Bond Price Formula', definition: 'P = Σ [C / (1+y)^t] + [F / (1+y)^n], where P = bond price, C = periodic coupon payment, y = periodic yield (YTM / periods per year), F = face value, n = number of periods, t = time period index. Example: 5-year bond, 4% annual coupon, £100 face value, YTM = 6%. P = 4/1.06 + 4/1.06² + 4/1.06³ + 4/1.06⁴ + 104/1.06⁵ = 3.774 + 3.560 + 3.358 + 3.168 + 77.726 = £91.58. Because YTM (6%) > coupon rate (4%), the bond prices at a discount to par.' },
          { type: 'text', content: 'This inverse relationship between price and yield — when yields rise, prices fall; when yields fall, prices rise — is the most fundamental axiom in fixed income. Intuitively: if new bonds are being issued at 6% coupon, a bond only paying 4% coupon is worth less, so its price falls until the lower coupon compensates for the yield differential.' },
          { type: 'heading', level: 3, content: 'Yield Measures: YTM, YTC, Current Yield' },
          { type: 'keyterm', term: 'Yield to Maturity (YTM)', definition: 'YTM is the single discount rate that equates the present value of all future cash flows to the current market price. It is the internal rate of return (IRR) of the bond held to maturity. Approximate formula: YTM ≈ [C + (F−P)/n] / [(F+P)/2]. Example: Bond price £91.58, coupon £4, face £100, 5 years. YTM ≈ [4 + (100−91.58)/5] / [(100+91.58)/2] = [4 + 1.684] / [95.79] = 5.684 / 95.79 = 5.94% (approximate; exact YTM = 6% via iteration).' },
          { type: 'keyterm', term: 'Yield to Call (YTC)', definition: 'YTC is calculated assuming the bond is called at the first call date rather than held to maturity. Callable bonds give the issuer the right to redeem early, typically at par or a small premium. YTC formula: same as YTM but n = periods to call date and F = call price. YTC is relevant when bonds trade above par (since issuers benefit from calling and refinancing at lower rates). Example: a callable bond maturing in 10 years but callable in 3 years at £102: YTC uses n=3 and F=£102.' },
          { type: 'keyterm', term: 'Current Yield', definition: 'Current Yield = Annual Coupon / Current Price. A simplified yield measure that ignores the time value of money and any capital gain/loss from buying at a discount or premium. Example: Bond with annual coupon £4 priced at £91.58: Current Yield = 4/91.58 = 4.37%. This understates the true yield because the investor also receives a £8.42 capital gain at maturity (buying at 91.58, receiving 100 at maturity). YTM at 6% properly captures this gain.' },
          { type: 'heading', level: 3, content: 'Reinvestment Risk' },
          { type: 'text', content: '<strong>Reinvestment risk</strong> is the risk that coupon payments received over a bond\'s life will be reinvested at a rate lower than the YTM assumed at purchase. YTM implicitly assumes all coupons are reinvested at the YTM rate itself — an assumption that rarely holds in practice. If coupons can only be reinvested at lower market rates (because yields have fallen), the realised return will be below the stated YTM.' },
          { type: 'text', content: 'Consider an investor buying the 4% coupon, 5-year bond at £91.58 (YTM = 6%) expecting to reinvest all coupons at 6%. If interest rates fall to 2% after purchase and coupons can only be reinvested at 2%, the total return will be below 6%. This is reinvestment risk materialising. <strong>Zero-coupon bonds</strong> have no reinvestment risk because there are no intermediate coupons — the only cash flow is the face value at maturity. Their YTM is thus a guaranteed realised return if held to maturity.' },
          { type: 'callout', style: 'info', title: 'The Coupon Effect on Reinvestment Risk', content: 'Higher-coupon bonds have greater reinvestment risk than lower-coupon bonds because more cash flow must be reinvested. A 10% coupon bond pays back more of its value early (through coupons), meaning a larger portion of total return depends on reinvestment rates. A zero-coupon bond has zero reinvestment risk. This is one reason why pension funds with long-dated, fixed liabilities sometimes prefer zero-coupon or low-coupon bonds — the reinvestment risk profile better matches their liability structure.' },
          { type: 'activity', style: 'truefalse', title: 'Bond Mathematics: True or False?', instructions: 'Evaluate each statement about bond pricing and yields.', items: [
            { statement: 'If a bond\'s YTM equals its coupon rate, the bond will price at par (face value).', answer: true },
            { statement: 'Current yield is always higher than YTM for a discount bond.', answer: false },
            { statement: 'Zero-coupon bonds have zero reinvestment risk because there are no intermediate cash flows.', answer: true },
            { statement: 'When market interest rates rise, existing bond prices also rise.', answer: false },
            { statement: 'YTC is most relevant for callable bonds trading significantly above par.', answer: true },
            { statement: 'YTM assumes all coupon payments are reinvested at the prevailing market rate at the time of each payment.', answer: false }
          ]}
        ]
      },
      {
        id: 'sec-f2fi-duration',
        title: 'Duration: Measuring Interest Rate Sensitivity',
        blocks: [
          { type: 'heading', level: 2, content: 'Duration: Measuring Interest Rate Sensitivity' },
          { type: 'text', content: '<strong>Duration</strong> is the most important risk measure in fixed income — it quantifies a bond\'s sensitivity to changes in interest rates. A bond with duration of 7 years will lose approximately 7% of its value if yields rise by 1% (100 basis points). Understanding duration is non-negotiable for anyone managing bonds or assessing interest rate risk.' },
          { type: 'heading', level: 3, content: 'Macaulay Duration' },
          { type: 'keyterm', term: 'Macaulay Duration', definition: 'Macaulay Duration = Σ [t × PV(CF_t)] / Bond Price, where PV(CF_t) = present value of cash flow at time t, and the sum is over all cash flow periods. Macaulay Duration is a weighted average of cash flow timing, where weights are the present values of each cash flow as a proportion of total bond price. For a zero-coupon bond, Macaulay Duration = maturity (since there is only one cash flow). Example: 2-year annual coupon bond, 6% coupon, 6% YTM (priced at par £100). Year 1: PV = 6/1.06 = 5.66, weight = 5.66/100 = 5.66%. Year 2: PV = 106/1.06² = 94.34, weight = 94.34%. Macaulay Duration = 1×0.0566 + 2×0.9434 = 0.0566 + 1.887 = 1.943 years.' },
          { type: 'heading', level: 3, content: 'Modified Duration: The Price Sensitivity Measure' },
          { type: 'keyterm', term: 'Modified Duration', definition: 'Modified Duration = Macaulay Duration / (1 + y/m), where y = YTM and m = coupon frequency per year. Modified Duration directly estimates the percentage price change per 1% (100 bps) change in yield: ΔP/P ≈ −Modified Duration × Δy. Example: Macaulay Duration = 1.943, YTM = 6%, annual coupons (m=1). Modified Duration = 1.943 / (1.06) = 1.833. If yields rise by 50 bps (0.005): ΔP/P ≈ −1.833 × 0.005 = −0.917%, so price falls from £100 to approximately £99.08.' },
          { type: 'heading', level: 3, content: 'Worked Example: 10-Year German Bund' },
          { type: 'text', content: 'Consider the benchmark 10-year German Bund with the following characteristics (hypothetical illustrative example): Coupon 2.30%, Face Value €100, Maturity 10 years, YTM 2.50%, Current Price approximately €98.27 (priced at a slight discount because YTM slightly exceeds coupon rate).' },
          { type: 'text', content: 'Macaulay Duration calculation: At YTM 2.50%, each annual cash flow (€2.30 for years 1-9, €102.30 in year 10) is discounted at 2.50%. The present value of year 10 cash flow is 102.30/1.025^10 = €79.85, representing 81.3% of total bond value. Weighted contribution = 10 × 81.3% = 8.13 years. All earlier coupon payments contribute approximately 0.87 years cumulatively. Total Macaulay Duration ≈ 9.00 years.' },
          { type: 'text', content: 'Modified Duration = 9.00 / (1.025) = 8.78. This means: for every 1% rise in yields, the Bund price falls approximately 8.78%. If yields spike by 200 bps (as they did in the 2022 rate shock): estimated price impact = −8.78% × 2.0 = −17.6%. This is why 2022 was such a catastrophic year for government bond investors — bonds that appeared "safe" experienced double-digit capital losses as the ECB raised rates from −0.5% to +2.0%.' },
          { type: 'callout', style: 'warning', title: 'Duration Is an Approximation', content: 'Modified Duration gives a linear approximation of price change. For small yield changes, it is accurate. For large yield changes (>1%), convexity (the curvature of the price-yield relationship) becomes significant. The full price change estimate requires: ΔP/P ≈ −ModDuration × Δy + 0.5 × Convexity × (Δy)². Without the convexity term, Modified Duration overstates the price decline when yields rise and understates the price gain when yields fall.' },
          { type: 'heading', level: 3, content: 'Duration of a Bond Portfolio' },
          { type: 'text', content: 'Portfolio duration is the weighted average of individual bond durations, weighted by market value. If a portfolio holds 40% in 5-year bonds (Modified Duration 4.3) and 60% in 10-year bonds (Modified Duration 8.5): Portfolio Duration = 0.40 × 4.3 + 0.60 × 8.5 = 1.72 + 5.10 = 6.82 years. This means the portfolio will lose approximately 6.82% of value for each 1% rise in yields — an important risk management figure for bond fund managers who may have duration targets set by their mandate.' }
        ]
      },
      {
        id: 'sec-f2fi-convexity',
        title: 'Convexity: The Curvature of Bond Prices',
        blocks: [
          { type: 'heading', level: 2, content: 'Convexity: The Curvature of Bond Prices' },
          { type: 'text', content: 'The price-yield relationship for a standard bond is not linear — it is <strong>convex</strong> (curving outward). This means that for large yield changes, the actual price change is better than the linear (Modified Duration) approximation predicts: bond prices fall <em>less</em> than expected when yields rise, and rise <em>more</em> than expected when yields fall. This asymmetry is called <strong>positive convexity</strong>, and investors value it — all else equal, a more convex bond is worth more than a less convex one.' },
          { type: 'keyterm', term: 'Convexity', definition: 'Convexity ≈ Σ [t(t+1) × PV(CF_t)] / [P × (1+y)²]. The full price change formula is: ΔP/P ≈ −ModDuration × Δy + 0.5 × Convexity × (Δy)². Convexity is always positive for standard non-callable bonds. Example: A bond with Modified Duration = 7.0 and Convexity = 60. If yields rise 2% (Δy = 0.02): Duration-only estimate = −7.0 × 0.02 = −14.0%. Convexity adjustment = +0.5 × 60 × (0.02)² = +0.5 × 60 × 0.0004 = +1.20%. Total price change ≈ −14.0% + 1.2% = −12.8%. The bond actually falls 12.8%, not 14%.' },
          { type: 'heading', level: 3, content: 'Why Convexity Matters for Large Rate Moves' },
          { type: 'text', content: 'For small yield changes (say, 25 bps), convexity adds trivial precision — the linear duration approximation is adequate. But for large moves (100+ bps) — which occurred in 2022, 2013 (Taper Tantrum), 1994, and 1987 — convexity becomes material. In the 2022 rate shock, 10-year Treasury yields rose from 1.5% to 4.0% — a 250 bps move. For a 10-year bond with ModDuration = 8.5 and Convexity = 80: Duration estimate = −8.5 × 0.025 = −21.25%. Convexity adjustment = +0.5 × 80 × (0.025)² = +0.5 × 80 × 0.000625 = +2.50%. Net estimated price change = −18.75%. Actual price changes were in this range for long-dated bonds.' },
          { type: 'heading', level: 3, content: 'Negative Convexity: Callable Bonds and MBS' },
          { type: 'text', content: '<strong>Callable bonds</strong> — bonds where the issuer has the right to redeem early — exhibit <strong>negative convexity</strong> in the region where yields are low enough to trigger calling. When yields fall, a callable bond\'s price rise is capped because the issuer will call the bond (preventing further price appreciation). But when yields rise, the bond falls normally. This asymmetry produces a price-yield profile that curves <em>inward</em> (concave) — negative convexity.' },
          { type: 'text', content: '<strong>Mortgage-Backed Securities (MBS)</strong> also typically exhibit negative convexity because homeowners have embedded call options: they can prepay mortgages when rates fall (refinancing). When rates fall, MBS investors suffer from prepayment — their bonds are effectively called at par just when they want to hold them (since new reinvestment rates are lower). This makes MBS structurally less attractive than equivalent-duration government bonds, requiring a spread premium (the "option-adjusted spread") to compensate.' },
          { type: 'callout', style: 'tip', title: 'Convexity as a Performance Differentiator', content: 'When market rate volatility is high, convexity matters more. A bond manager expecting high rate volatility should prefer more convex instruments (long-dated government bonds, zero-coupon bonds) over less convex ones (callable corporates, MBS). The convexity of a bond increases with maturity and decreases with coupon rate — a 30-year zero-coupon bond has extraordinary convexity, which explains its dramatic price sensitivity in both directions to yield changes.' }
        ]
      },
      {
        id: 'sec-f2fi-yieldcurve',
        title: 'The Yield Curve: Structure, Theories & Trading',
        blocks: [
          { type: 'heading', level: 2, content: 'The Yield Curve: Structure, Theories & Trading' },
          { type: 'text', content: 'The <strong>yield curve</strong> plots the yields of bonds with the same credit quality (typically government bonds) across different maturities — from overnight to 30 years. Its shape, shifts, and inversions are among the most watched indicators in financial markets, carrying information about monetary policy expectations, economic growth prospects, and inflation dynamics.' },
          { type: 'heading', level: 3, content: 'Yield Curve Shapes' },
          { type: 'text', content: '<strong>Normal (upward sloping):</strong> Long-term yields exceed short-term yields. The most common shape, reflecting compensation for inflation and uncertainty over longer time horizons. The US curve was typically 200-300 bps from 2-year to 10-year yields in "normal" environments (e.g., 2013-2018).' },
          { type: 'text', content: '<strong>Inverted:</strong> Short-term yields exceed long-term yields. Has preceded every US recession since 1950 with only one false positive. Occurs when the Fed raises short-term rates aggressively to fight inflation while the market prices in future rate cuts (as recession follows). The 2-year/10-year spread inverted in July 2022 and remained deeply inverted through 2023 — one of the most discussed macro signals of that period.' },
          { type: 'text', content: '<strong>Flat:</strong> Short and long-term yields are similar. Transition state, often occurring either early in a tightening cycle or late in an inversion before steepening resumes.' },
          { type: 'text', content: '<strong>Humped:</strong> Medium-term yields are highest. Relatively rare, occurring in specific transition phases.' },
          { type: 'heading', level: 3, content: 'Theories of the Yield Curve' },
          { type: 'text', content: '<strong>Pure Expectations Theory:</strong> Long-term rates are geometric averages of expected future short-term rates. If the market expects the 1-year rate to be 3% next year, the 2-year rate today should be approximately (1+2yr)² = (1+1yr now)(1+1yr forward) → consistent with rate expectations. Implication: an inverted curve means markets expect short-term rates to fall (i.e., the central bank will cut rates, likely because growth is slowing).' },
          { type: 'text', content: '<strong>Liquidity Preference Theory (Keynes):</strong> Investors prefer short-term bonds (more liquid, less price-volatile) and demand a <em>liquidity premium</em> for holding long-term bonds. Therefore, even if short-term rates are not expected to rise, the yield curve has an upward bias. This explains why the normal yield curve slopes upward even in stable rate environments.' },
          { type: 'text', content: '<strong>Market Segmentation Theory:</strong> Different investor groups have preferred maturity habitats determined by their liability structure: insurance companies and pension funds prefer long-dated bonds; banks prefer short-dated bonds. Supply and demand within each segment determines rates independently — rates are set more by structural investor demand than by rational expectations about future rates.' },
          { type: 'heading', level: 3, content: 'The 2022 Inversion: What Happened?' },
          { type: 'text', content: 'The US yield curve began inverting in April 2022 as the Federal Reserve embarked on its most aggressive rate-hiking cycle since the 1980s. The Fed Funds Rate rose from 0.25% in March 2022 to 5.25%-5.50% by July 2023 — 525 bps in 16 months. Short-term yields (2-year Treasury) rose sharply to track the Fed\'s rate path. Long-term yields (10-year Treasury) rose more slowly, peaking around 4.0-5.0%, as the market anticipated eventual rate cuts once inflation was controlled.' },
          { type: 'text', content: 'The 2-10 spread reached −108 bps in July 2023 — the deepest inversion since 1981. True to historical form, US economic growth slowed materially in 2023 (though recession was avoided). Regional bank stress (SVB, Signature, First Republic collapses in March 2023) illustrated the mechanism through which yield curve inversion causes financial stress: banks that borrow short-term (deposits at 0-1%) and lend long-term (mortgages at 3-4%) are squeezed as short rates rise but long loan yields are locked in at lower levels.' },
          { type: 'heading', level: 3, content: 'Yield Curve Trading Strategies' },
          { type: 'text', content: '<strong>Bullet strategy:</strong> Concentrate bond holdings at one point on the curve (e.g., 7-10 year maturities). Higher convexity at this single maturity; vulnerable to non-parallel yield curve shifts.' },
          { type: 'text', content: '<strong>Barbell strategy:</strong> Hold bonds at the short end (1-3 years) and long end (15-30 years), avoiding the middle. Higher convexity than bullet; performs well when the curve steepens (long yields fall relative to short). Short-maturity bonds provide liquidity as they mature and reinvest.' },
          { type: 'text', content: '<strong>Steepener/Flattener trades:</strong> An investor expecting the curve to steepen (short rates fall or long rates rise) would buy short-dated bonds and short long-dated bonds. A flattener does the reverse. These trades are structured to be duration-neutral (no net interest rate exposure) so they profit purely from the change in shape.' },
          { type: 'activity', style: 'multiplechoice', title: 'Yield Curve Concepts', instructions: 'Apply your knowledge of yield curve theory to these questions.', items: [
            { question: 'An inverted yield curve (short rates > long rates) historically signals:', options: ['Near-term acceleration in economic growth', 'Increased probability of future recession and rate cuts', 'Hyperinflation risk in the medium term', 'Central bank balance sheet expansion (QE)'], answer: 1 },
            { question: 'According to Liquidity Preference Theory, the yield curve has an upward bias because:', options: ['Long-term bonds are always riskier than short-term bonds due to credit risk', 'Investors prefer short-term bonds and demand a premium to hold long-dated instruments', 'The government always issues more long-term debt than short-term debt', 'Inflation is always higher in the long run'], answer: 1 },
            { question: 'A barbell bond portfolio holds bonds concentrated at:', options: ['The 5-7 year part of the curve only', 'Short (1-3 year) and long (15-30 year) maturities, avoiding the middle', 'Medium-term (7-10 year) maturities for maximum liquidity', 'Floating rate notes with no fixed maturity exposure'], answer: 1 },
            { question: 'The 2022 yield curve inversion was primarily driven by:', options: ['The Fed cutting rates aggressively while long yields rose', 'The Fed raising short-term rates aggressively while long yields rose more slowly', 'A structural collapse in long-term inflation expectations', 'European Central Bank QE suppressing US long-term yields'], answer: 1 }
          ]}
        ]
      },
      {
        id: 'sec-f2fi-creditratings',
        title: 'Credit Ratings & the Rating Agency System',
        blocks: [
          { type: 'heading', level: 2, content: 'Credit Ratings & the Rating Agency System' },
          { type: 'text', content: 'Credit ratings are opinions issued by specialist agencies on the likelihood that a borrower will meet its debt obligations in full and on time. They are used pervasively across fixed income markets to categorise credit risk, determine spread requirements, and define investment eligibility for institutional portfolios.' },
          { type: 'heading', level: 3, content: 'Rating Scales' },
          { type: 'text', content: 'The three major rating agencies — <strong>Moody\'s</strong>, <strong>S&P Global Ratings</strong>, and <strong>Fitch Ratings</strong> — use different but equivalent scales. Investment grade (low default risk): S&P/Fitch AAA, AA, A, BBB; Moody\'s Aaa, Aa, A, Baa. High yield / speculative grade (higher default risk): S&P/Fitch BB, B, CCC, CC, C, D; Moody\'s Ba, B, Caa, Ca, C. The investment grade / high yield divide at BBB−/Baa3 is structurally significant: many institutional investors (pension funds, insurance companies) are restricted by regulation or mandate to hold only investment-grade bonds. A downgrade across this boundary (a "fallen angel") triggers forced selling, often causing dramatic spread widening and price declines.' },
          { type: 'heading', level: 3, content: 'The Rating Process' },
          { type: 'text', content: 'The rating process begins when an issuer (typically voluntarily, and paying a fee to the agency) requests a rating. The agency assigns an analytical team that reviews public financial information, meets with management, and issues a draft rating to the issuer for review before public release. The rating committee makes the final decision by majority vote. Ratings are then monitored ongoing, with changes signalled via <strong>Rating Watch/CreditWatch</strong> (short-term review, positive or negative) or <strong>Outlook</strong> (medium-term directional signal — Positive, Negative, Stable).' },
          { type: 'callout', style: 'warning', title: 'The Issuer-Pays Model Controversy', content: 'All three major agencies use an "issuer-pays" model — the borrower pays the agency for its rating. This creates an obvious conflict of interest: agencies may be incentivised to issue favourable ratings to retain business. This conflict contributed to catastrophically high ratings assigned to subprime mortgage-backed securities before 2008 — CDOs backed by deteriorating mortgages were rated AAA. Post-GFC reforms (Dodd-Frank in the US, ESMA oversight in Europe) have increased regulatory scrutiny, but the fundamental business model has not changed.' },
          { type: 'heading', level: 3, content: 'Rating Migration & Cliff Risk' },
          { type: 'keyterm', term: 'Rating Migration', definition: 'Rating migration refers to transitions between rating categories over time. Moody\'s annual transition matrices show historical one-year migration probabilities. Key data points from Moody\'s historical analysis: Aaa-rated bonds have approximately 0.0% 1-year default rate; Baa-rated bonds have approximately 0.2% 1-year default rate; B-rated bonds approximately 3.6%; Caa-rated bonds approximately 10-15%. The cumulative 5-year default rates are higher: Ba (sub-investment grade) approximately 12%, B approximately 22%, Caa approximately 40-50%.' },
          { type: 'text', content: '<strong>Cliff risk</strong> refers to the discontinuous spread widening and price drop that occurs when a bond is downgraded from BBB−/Baa3 to BB+/Ba1 — the fallen angel threshold. Because many institutional investors are prohibited from holding sub-investment-grade bonds, a downgrade forces mechanically required selling regardless of whether fundamentals justify it. Italy\'s sovereign debt is frequently cited as exhibiting cliff risk: rated at the lowest investment-grade rung, any deterioration in fiscal dynamics risks a downgrade that would trigger forced selling by hundreds of regulated investors.' }
        ]
      },
      {
        id: 'sec-f2fi-igehigh',
        title: 'Investment Grade vs High Yield: The Divide',
        blocks: [
          { type: 'heading', level: 2, content: 'Investment Grade vs High Yield: The Divide' },
          { type: 'text', content: 'The investment grade / high yield divide is one of the most consequential demarcations in financial markets. On either side of the BBB−/BB+ boundary, the investor base, liquidity, spread dynamics, and analytical framework differ dramatically. Understanding both markets is essential for comprehensive fixed income analysis.' },
          { type: 'heading', level: 3, content: 'Spread Dynamics' },
          { type: 'text', content: 'Credit spreads are the yield premium over the risk-free rate (government bond yield) demanded by investors to compensate for default risk, liquidity risk, and uncertainty. Investment grade spreads are typically narrow (50-200 bps over government bonds for BBB bonds in normal markets). High yield spreads are wider and more volatile: BB bonds trade at 150-400 bps over governments in benign conditions; B bonds 300-600 bps; CCC bonds 800+ bps, often spiking to 1,500-2,000 bps in stress events.' },
          { type: 'text', content: 'Spread levels are mean-reverting over long periods but can remain at extremes for years. In the Global Financial Crisis (2008-2009), high yield spreads peaked at over 1,900 bps. In COVID (March 2020), they spiked to 1,100 bps before rapid Fed intervention compressed them back below 400 bps by end-2020. These episodes create significant opportunities for investors with the capital, mandate, and nerve to buy distressed bonds at extreme spreads.' },
          { type: 'heading', level: 3, content: 'Fallen Angels and Rising Stars' },
  ...
  'lesson-ecfl-f3-equity-adv': {
    sections: [
      ...
      // ── SECTION 1 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-dcf-multistage',
        title: 'Multi-Stage DCF: Terminal Value & Growth Rate Sensitivity',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            title: 'DCF Structure & Terminal Value',
            instructions: 'Select the best answer for each question.',
            items: [
              { question: 'A firm has WACC = 10%, terminal growth rate g = 4%, and Year 10 FCFF = €80m. What is the terminal value at the END of Year 10?', options: ['€1,333m', '€1,386m', '€1,120m', '€800m'], answer: 1 },
              { question: 'Which statement about FCFF vs FCFE is CORRECT?', options: ['FCFE is discounted at WACC to get equity value', 'FCFF includes the tax shield benefit in the discount rate via WACC', 'FCFE is always lower than FCFF for leveraged firms', 'Both should be discounted at the cost of equity'], answer: 1 },
              { question: 'Terminal value typically represents what percentage of total DCF enterprise value for a high-growth technology company?', options: ['20-30%', '40-50%', '60-80%', 'Over 90%'], answer: 2 },
              { question: 'In a sensitivity table for DCF, which variable combination produces the HIGHEST enterprise value?', options: ['High WACC, high terminal growth', 'Low WACC, high terminal growth', 'High WACC, low terminal growth', 'Low WACC, low terminal growth'], answer: 1 },
              { question: 'A terminal growth rate of 5.5% for a firm operating in a 2% inflation, 1.5% real GDP growth economy is:', options: ['Appropriate for a dominant market leader', 'Mathematically impossible in a DCF', 'Logically unsustainable as the firm would outgrow the economy', 'Conservative for a technology firm'], answer: 2 }
            ]
          }
        ]
      },
      ...
      {
        id: 'sec-f3-eq-wacc',
        title: 'WACC: Computation, Pitfalls & Adjustments',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'truefalse',
            title: 'WACC Computation Principles',
            instructions: 'State whether each claim is True or False.',
            items: [
              { statement: 'The marginal tax rate should be used (not the effective tax rate) when computing the after-tax cost of debt in WACC.', answer: true },
              { statement: 'Unlevering and re-levering beta using the Hamada equation is only necessary when the subject firm has the same capital structure as its peers.', answer: false },
              { statement: 'Under IFRS 16, capitalised operating lease liabilities should be included in the debt component of WACC.', answer: true },
              { statement: 'The Blume beta adjustment pushes raw betas toward zero to correct for measurement error.', answer: false },
              { statement: 'A firm with deferred tax assets and recent losses should use the statutory tax rate for the debt tax shield calculation without adjustment.', answer: false },
              { statement: 'Damodaran\'s implied ERP is a forward-looking measure derived from current market prices, making it theoretically superior to historical averages for DCF work.', answer: true }
            ]
          }
        ]
      },
      ...
      // ── SECTION 3 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-residual-income',
        title: 'Residual Income Valuation: The Ohlson Model',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 4 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-ev-multiples',
        title: 'EV Multiples in Depth: EV/EBITDA, EV/EBIT, EV/Sales',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'multiplechoice',
            title: 'EV Bridge and Multiple Selection',
            instructions: 'Choose the best answer.',
            items: [
              { question: 'A company has: Market Cap = €800m, Gross Debt = €300m, Cash = €50m, Minority Interests = €40m, Associates at equity value = €30m. What is the EV?', options: ['€1,060m', '€1,090m', '€1,030m', '€1,110m'], answer: 0 },
              { question: 'Why are minority interests ADDED to market cap in the EV bridge?', options: ['To account for subsidiaries\' tax liabilities', 'Because consolidated EBITDA includes 100% of subsidiary earnings including the minority-owned portion', 'To adjust for cross-holdings between group companies', 'Because minority holders have priority claims over equity holders'], answer: 1 },
              { question: 'For a capital-intensive industrial firm with CapEx/Revenue of 18%, which multiple is most appropriate?', options: ['EV/EBITDA', 'EV/Revenue', 'EV/EBIT or EV/(EBITDA - CapEx)', 'P/E ratio'], answer: 2 },
              { question: 'Under IFRS 16, which approach is internally CONSISTENT for EV/EBITDA calculation?', options: ['Include lease liabilities in EV, use pre-IFRS 16 EBITDA (before lease expense)', 'Include lease liabilities in EV, use post-IFRS 16 EBITDA (before depreciation and interest on lease)', 'Exclude lease liabilities, use post-IFRS 16 EBITDA', 'Either approach is consistent as long as it is applied uniformly'], answer: 1 },
              { question: 'A SaaS firm has 35% revenue growth and -8% EBITDA margin. Its Rule of 40 score is:', options: ['35', '43', '27', '-8'], answer: 2 }
            ]
          }
        ]
      },
      ...
      // ── SECTION 5 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-trading-comps',
        title: 'Trading Comparables: Screening & Adjusting Peer Groups',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-eq-lbo',
        title: 'LBO Modelling Fundamentals',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            description: 'A waterfall chart decomposing RetailCo LBO equity returns into three sources: (1) EBITDA Growth contribution: €160m EV increase from €50m to €70m EBITDA × 8× multiple — responsible for approximately 41% of value creation. (2) Debt paydown / deleveraging: €120m reduction in net debt from initial €280m to €170m — responsible for approximately 31% of value creation. (3) Multiple expansion/compression: assumed 0× in this example (entry = exit multiple). The chart shows that in practice, PE returns from 2010-2021 were disproportionately driven by multiple expansion (buyout multiples expanded from ~7× to ~11× EBITDA), a tailwind that reversed sharply in 2022-2023 as rates rose.'
          },
          {
            type: 'activity',
            style: 'multiplechoice',
            title: 'LBO Return Analysis',
            instructions: 'Select the best answer.',
            items: [
              { question: 'In a 5-year LBO with entry equity of €100m and exit equity proceeds of €250m, the MOIC is 2.5× and the IRR is approximately:', options: ['20.1%', '25.9%', '17.0%', '22.5%'], answer: 0 },
              { question: 'Which debt tranche in an LBO typically carries the highest interest rate?', options: ['Term Loan A (TLA)', 'Term Loan B (TLB)', 'Mezzanine/PIK notes', 'Revolving Credit Facility'], answer: 2 },
              { question: 'A "covenant-lite" leveraged loan means:', options: ['The loan has no financial covenants at all', 'The loan only has incurrence covenants (triggered by actions), not maintenance covenants (tested quarterly)', 'The borrower has reduced reporting obligations', 'The loan is unrated and therefore exempt from standard bank regulations'], answer: 1 },
              { question: 'Which of the following is the PRIMARY driver of LBO equity returns in a scenario with flat EBITDA and unchanged exit multiple?', options: ['Revenue growth', 'Margin expansion', 'Debt paydown from free cash flow', 'Tax optimisation'], answer: 2 }
            ]
          }
        ]
      },
      ...
      // ── SECTION 7 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-ma-valuation',
        title: 'M&A Valuation: Accretion/Dilution & Synergy Analysis',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 9 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-real-options',
        title: 'Real Options in Equity Valuation',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 10 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-short-selling',
        title: 'Short Selling: Mechanics, Catalysts & Risk',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'truefalse',
            title: 'Short Selling Fundamentals',
            instructions: 'State True or False.',
            items: [
              { statement: 'A short seller profits when the price of the borrowed shares declines.', answer: true },
              { statement: 'Short sellers are not obligated to pay dividends on borrowed shares.', answer: false },
              { statement: 'High Days-to-Cover (DTC) is generally considered a risk-reducing factor for short positions.', answer: false },
              { statement: 'The maximum theoretical loss on a short position is limited to 100% of the initial sale proceeds.', answer: false },
              { statement: 'A catalyst is necessary for a short thesis to be actionable within a reasonable investment horizon.', answer: true },
              { statement: 'Wirecard\'s fraud was ultimately exposed by Muddy Waters Research, a well-known short-selling research firm.', answer: false }
            ]
          }
        ]
      },
      ...
      // ── SECTION 11 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-special-situations',
        title: 'Special Situations: Spin-offs, SPACs & Restructurings',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-eq-ipo',
        title: 'IPO Valuation & Book-Building Process',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            style: 'matching',
            title: 'IPO Concepts',
            instructions: 'Match each concept with its correct description.',
            items: [
              { left: 'Greenshoe Option', right: 'Allows underwriter to sell 15% additional shares for price stabilisation' },
              { left: 'Lockup Period', right: '180-day restriction on insider share sales post-IPO' },
              { left: 'Book-Building', right: 'Process of soliciting institutional investor demand prior to pricing' },
              { left: 'First-Day Return Anomaly', right: 'Average 10-20% IPO price appreciation on listing day due to underpricing' },
              { left: 'Pre-IPO Discount', right: '20-30% valuation discount for private investors reflecting illiquidity risk' },
              { left: 'Oversubscription', right: 'Total demand exceeds shares available; typically 3-10× in successful IPOs' }
            ]
          }
        ]
      },
      ...
      // ── SECTION 13 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-franchise-value',
        title: 'Franchise Value & Economic Moat Valuation',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 14 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eq-activist',
        title: 'Activist Investing & Value Unlock Strategies',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'multiplechoice',
            title: 'Special Situations & Corporate Events',
            instructions: 'Select the best answer.',
            items: [
              { question: 'Which factor best explains the documented post-spin-off outperformance of newly independent entities?', options: ['Spin-offs are always higher quality businesses than their parents', 'Technical selling pressure from mandate-constrained institutional holders creates undervaluation at separation', 'Spun entities have access to cheaper debt capital as standalone companies', 'Management teams of spun entities have longer tenures and more experience'], answer: 1 },
              { question: 'An activist investor\'s "credible threat" primarily refers to:', options: ['The ability to acquire a controlling stake through open market purchases', 'The ability to run a proxy contest for board control if demands are not met', 'The ability to short the stock and drive the price down', 'Access to confidential information about the target company'], answer: 1 },
              { question: 'A SPAC investor who redeems their shares at NAV upon a deal announcement they dislike will:', options: ['Lose their warrant value but retain principal', 'Receive slightly less than $10 per share due to trust expenses', 'Receive their pro-rata share of the trust (close to $10 + accrued interest) and keep their warrants', 'Forfeit both principal and warrants'], answer: 2 },
              { question: 'The "absolute priority rule" in bankruptcy proceedings states:', options: ['Senior creditors must be paid before junior creditors receive any recovery', 'Equity holders receive absolute priority in liquidation over all other claimants', 'Management bonuses have priority over secured creditor claims', 'Tax claims are always subordinated to secured debt in reorganisation'], answer: 0 }
            ]
          }
        ]
      }

    ] // end sections for lesson-ecfl-f3-equity-adv
  }, // end lesson-ecfl-f3-equity-adv
  ...
  'lesson-ecfl-f3-credit': {
    sections: [
      ...
      // ── SECTION 1 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-cr-expected-loss',
        title: 'Credit Risk: PD, LGD, EAD & Expected Loss',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'Apply the EL = PD × LGD × EAD framework.',
            items: [
              { question: 'A bank has a €500m term loan to a BB-rated company. PD = 1.5%, LGD = 55%. What is the annual expected loss?', options: ['€4.125m', '€7.5m', '€3.75m', '€8.25m'], answer: 0 },
              { question: 'Under Basel III, what Credit Conversion Factor (CCF) applies to undrawn revolving credit facilities with maturity > 1 year?', options: ['0%', '50%', '75%', '100%'], answer: 2 },
              { question: 'Why does economic capital cover Unexpected Loss rather than Expected Loss?', options: ['Expected Loss is too small to matter', 'Expected Loss is provisioned through the income statement and pricing; capital must cover the tail risk beyond EL', 'Unexpected Loss is always larger than economic capital', 'Regulatory requirements exclude Expected Loss from capital calculations entirely'], answer: 1 },
              { question: 'A CDS spread of 450bps with an assumed LGD of 60% implies an approximate annual PD of:', options: ['2.7%', '7.5%', '4.5%', '27%'], answer: 1 },
              { question: 'Which asset class typically has the LOWEST LGD (highest recovery rate)?', options: ['Subordinated bonds', 'Equity', 'Senior secured term loans with first lien on assets', 'Mezzanine notes'], answer: 2 }
            ]
          }
        ]
      },
      ...
      // ── SECTION 2 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-cr-five-cs',
        title: 'Corporate Credit Analysis: The Five Cs & Beyond',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 3 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-cr-lev-finance',
        title: 'Leveraged Finance: High Yield Bonds & Leveraged Loans',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'truefalse',
            title: 'Leveraged Finance Structures',
            instructions: 'State True or False.',
            items: [
              { statement: 'High yield bonds are typically fixed-rate instruments, while leveraged loans are typically floating-rate instruments.', answer: true },
              { statement: 'Covenant-lite loans provide stronger lender protections than loans with maintenance covenants.', answer: false },
              { statement: 'A PIK toggle note that elects PIK payment for 2 years at 10% rate will have its principal grow to approximately 121% of the original face value.', answer: true },
              { statement: 'In a leveraged buyout capital structure, second lien lenders have priority claim over first lien lenders in a bankruptcy proceeding.', answer: false },
              { statement: 'A unitranche facility is a direct lending structure that combines first and second lien debt into a single instrument with a blended interest rate.', answer: true },
              { statement: 'The leveraged loan market primarily uses fixed interest rates, making it suitable for duration-sensitive investors.', answer: false }
            ]
          }
        ]
      },
      ...
      {
        id: 'sec-f3-cr-cds',
        title: 'Credit Default Swaps: Mechanics, Pricing & Uses',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'multiplechoice',
            title: 'CDS Mechanics & Pricing',
            instructions: 'Choose the best answer.',
            items: [
              { question: 'In a post-Big Bang CDS contract on a high-yield reference entity trading at 650bps, with a standard coupon of 500bps, the protection buyer will:', options: ['Pay 650bps per year as a running spread', 'Pay an upfront payment of approximately 150bps × duration, plus 500bps running', 'Receive an upfront payment since the spread exceeds 500bps', 'Pay 500bps running with no upfront adjustment'], answer: 1 },
              { question: 'A "negative CDS basis trade" involves:', options: ['Selling CDS protection and selling the reference bond', 'Buying the reference bond and buying CDS protection to lock in a risk-free spread', 'Buying CDS protection and short-selling the reference bond', 'Trading CDS index vs single-name CDS'], answer: 1 },
              { question: 'John Paulson\'s "Greatest Trade Ever" (2007) was primarily executed through:', options: ['Buying put options on bank stocks', 'Short-selling mortgage-backed securities in the open market', 'Buying CDS protection on subprime MBS via the ABX index', 'Short-selling housing ETFs'], answer: 2 },
              { question: 'The iTraxx Europe index contains how many investment-grade European reference entities?', options: ['75', '100', '125', '250'], answer: 2 }
            ]
          }
        ]
      },
      ...
      // ── SECTION 5 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-cr-synthetic-cdo',
        title: 'Synthetic CDOs & the 2008 Crisis',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-cr-mbs',
        title: 'Mortgage-Backed Securities: Agency vs Non-Agency',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'Match each MBS concept to its correct definition.',
            items: [
              { left: 'Agency MBS', right: 'Backed by Fannie Mae, Freddie Mac, or Ginnie Mae; carries government guarantee' },
              { left: 'CPR', right: 'Annualised percentage of mortgage pool that prepays each month' },
              { left: 'PAC Bond', right: 'CMO tranche receiving scheduled principal within a defined prepayment speed band' },
              { left: 'IO Strip', right: 'Receives only interest; rises in value when interest rates rise' },
              { left: '100% PSA', right: 'Benchmark prepayment speed ramping to 6% CPR by month 30' },
              { left: 'Support Bond', right: 'CMO companion tranche absorbing excess prepayment variability' }
            ]
          }
        ]
      },
      ...
      {
        id: 'sec-f3-cr-clo',
        title: 'CLOs: Structure, Tranches & Manager Selection',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 9 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-cr-sovereign',
        title: 'Sovereign Credit & EM Debt',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-cr-abs',
        title: 'Asset-Backed Securities: Auto, Student Loan & Credit Card ABS',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'multiplechoice',
            title: 'ABS Structures and Credit Analysis',
            instructions: 'Choose the best answer.',
            items: [
              { question: 'In an ABS structure, "excess spread" refers to:', options: ['The difference between the senior and junior note coupon rates', 'The difference between the collateral pool yield and the ABS note coupon rate', 'The amount of overcollateralisation in the pool', 'The premium earned by the structuring bank'], answer: 1 },
              { question: 'Bankruptcy remoteness in ABS structures is achieved through:', options: ['A government guarantee on the ABS notes', 'Transferring assets to a Special Purpose Vehicle (SPV) that is legally separate from the originator', 'Obtaining a AAA rating from all three major rating agencies', 'Insuring the collateral pool against default losses'], answer: 1 },
              { question: 'In a sequential-pay ABS waterfall, which tranche has the shortest expected duration?', options: ['The equity/residual tranche', 'The most senior (Class A) tranche', 'The mezzanine tranche', 'All tranches have equal duration'], answer: 1 },
              { question: 'Which ABS collateral type is most exposed to government policy changes that can affect repayment behaviour?', options: ['Auto loan ABS', 'Credit card ABS', 'Student loan ABS', 'Equipment lease ABS'], answer: 2 }
            ]
          }
        ]
      },
      ...
      // ── SECTION 13 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-cr-credit-ratings',
        title: 'Credit Rating Methodology & Rating Agency Analysis',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 14 ──────────────────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            instructions: 'State True or False.',
            items: [
              { statement: 'Direct lending loans typically maintain maintenance covenants, providing stronger lender protections than syndicated covenant-lite loans.', answer: true },
              { statement: 'Direct lending typically prices tighter (lower spread) than equivalent syndicated leveraged loans due to the lender\'s superior underwriting capability.', answer: false },
              { statement: 'A fallen angel is an investment-grade bond that has been upgraded to high yield status.', answer: false },
              { statement: 'Rating agencies aim to assign "through-the-cycle" ratings rather than ratings that change with every quarterly earnings report.', answer: true },
              { statement: 'Moody\'s Caa rating category corresponds approximately to S&P\'s CCC rating category.', answer: true }
            ]
          }
        ]
      }

    ] // end sections for lesson-ecfl-f3-credit
  }, // end lesson-ecfl-f3-credit
  ...
  'lesson-ecfl-f3-ethics': {
    sections: [
      ...
      // ── SECTION 1 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-cfa-code',
        title: 'The CFA Institute Code of Ethics & Standards of Professional Conduct',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'multiplechoice',
            title: 'CFA Code & Standards Framework',
            instructions: 'Choose the best answer.',
            items: [
              { question: 'Under the CFA Institute Code of Ethics, when a member\'s personal interests conflict with client interests, the member must:', options: ['Disclose the conflict and manage it appropriately', 'Always place client interests above personal interests', 'Seek approval from their employer before proceeding', 'Withdraw from the situation entirely'], answer: 1 },
              { question: 'Which CFA Standard specifically addresses Material Non-Public Information?', options: ['Standard I (Professionalism)', 'Standard II (Integrity of Capital Markets)', 'Standard III (Duties to Clients)', 'Standard VI (Conflicts of Interest)'], answer: 1 },
              { question: 'The key distinction between the US fiduciary standard (for RIAs) and the suitability standard (historically for broker-dealers) is:', options: ['Fiduciary requires CFA charter; suitability does not', 'Fiduciary requires acting in the client\'s best interest at all times; suitability requires only that recommendations be appropriate', 'Fiduciary applies to institutional clients; suitability to retail clients', 'Fiduciary requires written agreements; suitability is oral'], answer: 1 },
              { question: 'Standard V requires that investment recommendations have a "reasonable and adequate basis." This means:', options: ['All recommendations must be based on quantitative models', 'Recommendations must be supported by appropriate research and investigation', 'Analysts must seek peer review before publishing', 'Recommendations must be reviewed by a compliance officer'], answer: 1 }
            ]
          }
        ]
      },
      ...
      // ── SECTION 2 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-std1-professionalism',
        title: 'Standard I: Professionalism — Knowledge of Law & Misconduct',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-eth-mnpi',
        title: 'Standard II: Integrity of Capital Markets — Material Non-Public Information',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'truefalse',
            title: 'MNPI and Market Integrity',
            instructions: 'State True or False.',
            items: [
              { statement: 'Under the mosaic theory, an analyst can legally combine public information and material non-public information to reach an investment conclusion.', answer: false },
              { statement: 'EU Market Abuse Regulation (MAR) applies to market abuse occurring within EU member states regardless of the nationality of the perpetrator.', answer: true },
              { statement: 'A portfolio manager who purchases shares after receiving a "market sounding" from an M&A bank (conducted under proper MAR procedures) is always in breach of insider trading rules.', answer: false },
              { statement: 'The US "misappropriation theory" of insider trading allows prosecution of outsiders who trade on information misappropriated from parties to whom they owed a duty of confidence.', answer: true },
              { statement: 'An analyst who independently models a company\'s earnings decline using publicly available data and reaches the correct conclusion before earnings announcement is engaged in insider trading.', answer: false },
              { statement: 'The Raj Rajaratnam/Galleon case was the largest hedge fund insider trading prosecution in US history at the time of conviction.', answer: true }
            ]
          }
        ]
      },
      ...
      // ── SECTION 4 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-duties-clients',
        title: 'Standard III: Duties to Clients — Loyalty, Care & Prudent Investor Rule',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 5 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-std4-7',
        title: 'Standard IV-VII: Duties to Employers, Investment Analysis & Conflicts',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 6 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-manipulation',
        title: 'Market Manipulation: Forms, Detection & Regulation',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 7 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-conflicts',
        title: 'Conflicts of Interest: Management & Disclosure',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'Choose the best answer.',
            items: [
              { question: 'A portfolio manager receives a €5,000 "soft dollar" credit from her broker for directing €500,000 of client trades to that broker at above-market commissions. Under CFA Standards:', options: ['This is acceptable if the research received is used to benefit client portfolios and is fully disclosed', 'This is a per se violation of Standard III regardless of disclosure', 'Soft dollar arrangements are prohibited under any circumstances', 'This is acceptable as long as total commissions paid do not exceed 1% of trade value'], answer: 0 },
              { question: 'Under MiFID II, EU asset managers must pay for sell-side research:', options: ['From client accounts, provided it is disclosed in the fund prospectus', 'From their own P&L or from a separate Research Payment Account (RPA) funded transparently', 'Through commission sharing arrangements with any broker', 'Through standard bundled commission rates from designated research brokers'], answer: 1 },
              { question: 'An analyst at a bank receives a substantial bonus tied to the investment banking fees generated from her covered companies. This creates a conflict because:', options: ['Analysts should not receive bonuses at all', 'The compensation structure incentivises the analyst to provide favourable research to banking clients', 'Banking fees and research commissions are separate revenue lines that cannot interact', 'The analyst may trade on client order information'], answer: 1 },
              { question: 'Under the CFA Standards, a referral fee arrangement is:', options: ['Always prohibited as a conflict of interest', 'Permitted if disclosed to clients and employers', 'Only permitted for institutional clients', 'Permitted if it does not exceed 0.5% of the referred business value'], answer: 1 }
            ]
          }
        ]
      },
      ...
      // ── SECTION 8 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-esg-frameworks',
        title: 'ESG Investing Frameworks: SFDR, EU Taxonomy & TCFD',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 9 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-climate-risk',
        title: 'Climate Risk in Financial Analysis: Physical & Transition Risk',
        blocks: [
          {
            type: 'text',
      ...
      // ── SECTION 11 ──────────────────────────────────────────────────────────
      {
        id: 'sec-f3-eth-stewardship',
        title: 'Stewardship & Shareholder Activism',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'Match each framework to its description.',
            items: [
              { left: 'SFDR Article 9', right: 'Fund with sustainable investment as primary objective; "dark green"' },
              { left: 'TCFD', right: 'Four-pillar climate disclosure framework: Governance, Strategy, Risk Management, Metrics' },
              { left: 'UK Stewardship Code 2020', right: 'FRC standard requiring institutional investors to engage responsibly with companies' },
              { left: 'DNSH Principle', right: 'Requirement that sustainable activities not significantly harm other environmental objectives' },
              { left: 'IRIS+', right: 'GIIN-managed standardised impact measurement metrics aligned with SDGs' },
              { left: 'NGFS Scenarios', right: 'Central bank coalition\'s standardised climate pathways for financial risk assessment' }
            ]
          }
        ]
      },
      ...
      {
        id: 'sec-f3-eth-gips',
        title: 'Professional Responsibilities: GIPS & Performance Reporting',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-eth-dei',
        title: 'Diversity, Equity & Inclusion in Investment Management',
        blocks: [
          {
            type: 'text',
    ...
    ] // end sections for lesson-ecfl-f3-ethics
  }, // end lesson-ecfl-f3-ethics

// ═══ F3 EXPANDED SECTIONS (append to existing lessons) ═══
  ...
  'lesson-ecfl-f3-derivatives-extra': {
    sections: [
      ...
      // ── NEW SECTION A ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-drv-vol-trading',
        title: 'Volatility Trading: VIX, Variance Swaps & Vol Surfaces',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            type: 'activity',
            style: 'multiplechoice',
            title: 'Volatility Instruments',
            instructions: 'Choose the best answer.',
            items: [
              { question: 'The VIX measures which of the following?', options: ['30-day realised volatility of the S&P 500', 'Market-implied 30-day forward volatility of the S&P 500 derived from option prices', '1-year historical volatility of the VIX index itself', 'The spread between put and call implied volatility for ATM SPX options'], answer: 1 },
              { question: 'A variance swap with notional vega of €50,000, strike variance of 400 (vol = 20%), and realised variance of 900 (vol = 30%) pays:', options: ['€25m to the long side', '€50,000 × 500 = €25m to the long side', '€50,000 × 10 = €500,000 to the long side', '€50,000 × (30-20) = €500,000 to the long side'], answer: 1 },
              { question: 'The equity volatility skew (OTM puts having higher implied vol than OTM calls) reflects:', options: ['Higher demand for leveraged upside via call options', 'Investor demand for downside protection and the fat left tail in equity return distributions', 'Market makers charging more for puts due to supply constraints', 'Tax advantages of put options over call options'], answer: 1 },
              { question: 'In which market condition does the VIX term structure typically invert (near-term vol > long-term vol)?', options: ['During a prolonged bull market with low realised vol', 'During market crisis or severe stress events', 'When the Federal Reserve is raising interest rates', 'During corporate earnings season'], answer: 1 }
            ]
          }
        ]
      },
      ...
      // ── NEW SECTION B ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-drv-exotic-options',
        title: 'Exotic Options: Barrier, Asian, Digital & Compound',
        blocks: [
          {
            type: 'text',
      ...
      // ── NEW SECTION C ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-drv-options-strategies',
        title: 'Options Strategies: Spreads, Condors & Risk Reversals',
        blocks: [
          {
            type: 'text',
      ...
      // ── NEW SECTION D ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-drv-structured-products',
        title: 'Structured Products: Capital-Protected Notes & Autocallables',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'State True or False.',
            items: [
              { statement: 'A capital-protected note guarantees full return of principal regardless of the creditworthiness of the issuing institution.', answer: false },
              { statement: 'An autocallable note\'s periodic call trigger is based on whether the reference asset exceeds a specified level at each observation date.', answer: true },
              { statement: 'A "worst-of" autocallable references the best-performing asset in a basket to determine payoff.', answer: false },
              { statement: 'The participation rate in a capital-protected note falls as interest rates rise, because the zero-coupon bond component costs more.', answer: false },
              { statement: 'Retail structured note investors in Lehman Brothers notes suffered losses at Lehman\'s 2008 bankruptcy because structured notes are unsecured obligations of the issuer.', answer: true }
            ]
          }
        ]
      },
      ...
      // ── NEW SECTION E ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-drv-ir-derivatives',
        title: 'Interest Rate Derivatives: Caps, Floors & Swaptions',
        blocks: [
          {
            type: 'text',
      ...
      // ── NEW SECTION F ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-drv-commodity-futures',
        title: 'Commodity Derivatives: Futures Curves & Roll Yield',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'State True or False.',
            items: [
              { statement: 'In a contango market, a futures investor who rolls the front-month contract forward incurs a negative roll yield.', answer: true },
              { statement: 'Backwardation in commodity futures typically signals that the market expects future spot prices to be higher than current spot prices.', answer: false },
              { statement: 'The Bloomberg Commodity Index uses an optimised roll strategy to minimise the cost of rolling in contango markets.', answer: true },
              { statement: 'Agricultural commodity futures tend to be in contango before harvest season when new supply is about to enter the market.', answer: false },
              { statement: 'A commodity producer selling futures contracts to hedge is said to be "short the basis."', answer: false }
            ]
          }
        ]
      },
      ...
      // ── NEW SECTION G ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-drv-clearing-regulation',
        title: 'Central Clearing & Derivatives Regulation Post-2008',
        blocks: [
          {
            type: 'text',
    ...
    ] // end sections for lesson-ecfl-f3-derivatives-extra
  }, // end lesson-ecfl-f3-derivatives-extra
  ...
  'lesson-ecfl-f3-regulation-extra': {
    sections: [
      ...
      // ── NEW SECTION 1 ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-reg-basel3',
        title: 'Basel III: Capital Requirements, LCR & NSFR',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'Choose the best answer.',
            items: [
              { question: 'Under Basel III, the minimum CET1 ratio (including capital conservation buffer) is:', options: ['4.5%', '6.0%', '7.0%', '8.0%'], answer: 2 },
              { question: 'The Liquidity Coverage Ratio (LCR) measures:', options: ['Capital adequacy relative to risk-weighted assets', 'Ability to survive a 30-day liquidity stress using high-quality liquid assets', 'Funding stability matching long-term assets to stable liabilities', 'Leverage relative to total on-balance-sheet exposure'], answer: 1 },
              { question: 'Basel III\'s "output floor" primarily aims to:', options: ['Limit the absolute size of bank balance sheets', 'Prevent IRB-model-driven RWA from falling more than 72.5% below standardised approach RWA', 'Require all banks to use the standardised approach from 2025', 'Cap the leverage ratio at 3% for all banks'], answer: 1 },
              { question: 'Additional Tier 1 (AT1) instruments (CoCo bonds) are characterised by:', options: ['Senior secured claims on bank assets in liquidation', 'Ability to absorb losses through conversion to equity or write-down when CET1 hits a trigger', 'Fixed maturity dates and guaranteed interest payments', 'Zero regulatory capital credit under Basel III'], answer: 1 }
            ]
          }
        ]
      },
      ...
      // ── NEW SECTION 2 ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-reg-solvency2',
        title: 'Solvency II: Insurance Capital Framework',
        blocks: [
          {
            type: 'text',
      ...
      // ── NEW SECTION 3 ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-reg-dodd-frank',
        title: 'Dodd-Frank & the US Regulatory Architecture',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-reg-emir',
        title: 'EMIR & Derivatives Market Reform',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'Match each regulatory provision to its framework.',
            items: [
              { left: 'Mandatory central clearing of standardised OTC derivatives', right: 'EMIR (EU) / Dodd-Frank Title VII (US)' },
              { left: 'Volcker Rule — proprietary trading prohibition', right: 'Dodd-Frank Act (US)' },
              { left: 'LCR: High Quality Liquid Assets / Net Cash Outflows ≥ 100%', right: 'Basel III' },
              { left: 'Solvency Capital Requirement (SCR) — 99.5% VaR over 1 year', right: 'Solvency II (EU insurance)' },
              { left: 'AT1 CoCo bonds that convert to equity at CET1 trigger', right: 'Basel III Additional Tier 1 framework' },
              { left: 'Annual bank stress tests published with CET1 projections under adverse scenarios', right: 'DFAST / CCAR (Dodd-Frank)' }
            ]
          }
        ]
      },
      ...
      // ── NEW SECTION 5 ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-reg-market-structure',
        title: 'Market Structure: Dark Pools, HFT & Best Execution',
        blocks: [
          {
            type: 'text',
      ...
      {
        id: 'sec-f3-reg-gdpr',
        title: 'GDPR & Data Governance in Financial Services',
        blocks: [
          {
            type: 'text',
      ...
      // ── NEW SECTION 7 ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-reg-crypto',
        title: 'Crypto Regulation: MiCA Deep Dive & Global Landscape',
        blocks: [
          {
            type: 'text',
      ...
      // ── NEW SECTION 8 ──────────────────────────────────────────────────────
      {
        id: 'sec-f3-reg-sanctions',
        title: 'Sanctions & Financial Crime Compliance',
        blocks: [
          {
            type: 'text',
          ...
          },
          {
            ...
            instructions: 'Choose the best answer.',
            items: [
              { question: 'Under MiCA, which type of stablecoin requires the issuer to be licensed as an e-money institution?', options: ['Asset-Referenced Tokens (ARTs)', 'E-Money Tokens (EMTs)', 'Utility tokens', 'All crypto-assets backed by fiat currency'], answer: 1 },
              { question: 'OFAC\'s "secondary sanctions" differ from primary sanctions because:', options: ['They apply only to US financial institutions', 'They restrict non-US entities from engaging in sanctioned activities even without a US nexus', 'They require UN Security Council approval to impose', 'They are advisory only and carry no enforcement authority'], answer: 1 },
              { question: 'The GDPR\'s mandatory data breach notification to supervisory authorities must occur within:', options: ['24 hours of discovery', '72 hours of discovery', '7 days of discovery', '30 days of discovery'], answer: 1 },
              { question: 'Under MiFID II, Payment for Order Flow (PFOF) for retail orders is:', options: ['Permitted provided it is disclosed to clients', 'Banned — considered a conflict of interest inconsistent with best execution', 'Permitted for orders up to €10,000 in value', 'Regulated but not prohibited under MiFID II Article 27'], answer: 1 },
              { question: 'The FATF Travel Rule for crypto-assets requires VASPs to transmit beneficiary and originator information for transfers above:', options: ['$500', '$1,000', '$3,000', '$10,000'], answer: 1 }
            ]
          }
        ]
      }

    ] // end sections for lesson-ecfl-f3-regulation-extra
  } // end lesson-ecfl-f3-regulation-extra
